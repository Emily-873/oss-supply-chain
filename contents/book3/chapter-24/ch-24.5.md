---
title: "Protecting Yourself as a Maintainer"
description: "Burnout is a security vulnerability—attackers can exploit maintainer exhaustion. Your wellbeing isn't separate from project security; it's foundational to it."
icon: "lucide/heart"
---

# 24.5 Protecting Yourself as a Maintainer

!!! warning "Burnout Is a Security Vulnerability"

    The XZ Utils incident showed how attackers can exploit maintainer exhaustion and social pressure. A burned-out maintainer makes mistakes, accepts help uncritically, and may miss social engineering attempts. Your wellbeing isn't separate from project security—it's foundational to it.

Open source maintainership can be deeply rewarding—your code helps people, you're part of a global community, and you develop skills that matter. But it can also be exhausting, isolating, and sometimes dangerous. Maintainers face demanding users, corporations expecting free support, sophisticated social engineering attacks, and occasionally harassment. The XZ Utils incident[^xz-utils-wiki] showed that attackers can exploit maintainer exhaustion and social pressure as vulnerabilities.
...
!!! tip "Boundaries Protect Project and Maintainer"

    "This is a volunteer-maintained project. If you need faster resolution: contribute a fix yourself, hire someone to create a fix (we welcome PRs), or use commercial alternatives with support SLAs."
...
| **X (formerly Twitter)** | Report post/account |
...
[^tidelift-survey]: Tidelift, "Finding 1: About Half of Maintainers Get Paid Nothing for Their Work," 2021, archived at https://web.archive.org/web/20221209021946/https://blog.tidelift.com/finding-1-about-half-of-maintainers-get-paid-nothing-for-their-work
[^osmi]: Open Sourcing Mental Illness (OSMI), archived at https://web.archive.org/web/20231226071253/https://osmihelp.org/
