---
title: "Working with Security Researchers"
description: "Good relationships attract good researchers—projects known for positive researcher interactions get more skilled, ethical attention while hostile projects drive researchers away."
icon: "lucide/users"
---
...
- **@researcher1** - Authentication bypass (CVE-2025-XXXX)
- **Jane Smith** (Company) - XSS in admin panel (CVE-2025-XXXX)
- **Security Team, Example Corp** - Rate limiting bypass

## 2024

- **@researcher2** - SQL injection in search (CVE-2024-XXXX)

...

Want to be listed here? See SECURITY.md.
```
...
**Research support and bug bounty options**:

| Platform | Model | Best For |
|----------|-------|----------|
| **GitHub Security Lab**[^github-security-lab] | CodeQL tooling + Secure Open Source Fund[^github-sos-fund] grants; not a per-vulnerability bounty platform | GitHub-hosted projects seeking security hardening support |
...
| **Open Bug Bounty**[^open-bug-bounty] | Free, community-driven coordinated disclosure for web vulnerabilities | Projects with public web assets and no bounty budget |
...
- Secure Open Source Fund[^github-sos-fund-details] grants for maintainer-led security work
