---
title: "Managing Security-Sensitive Contributions"
description: "Social engineering defeats technical controls—the XZ Utils attacker spent years building trust before inserting a backdoor. Balance welcoming contributions with appropriate caution."
icon: "lucide/git-pull-request"
---

# 24.3 Managing Security-Sensitive Contributions

!!! danger "Social Engineering Defeats Technical Controls"

    The XZ Utils attacker "Jia Tan" spent years building trust through helpful patches before inserting a backdoor. Ordinary review did not catch it because trust and build-system complexity reduced scrutiny. Social engineering the maintainer is often easier than defeating technical controls.

The XZ Utils compromise[^xz-utils-wiki], discovered in March 2024,[^xz-utils] revealed a sobering reality: patient, sophisticated attackers will spend years building trust to insert malicious code into critical projects. The attacker "Jia Tan" contributed helpful patches and gradually assumed maintainer-like responsibilities before inserting a backdoor that would have affected many Linux systems. This was not just a technical failure—ordinary review did not catch the backdoor because trust, release artifacts, test fixtures, and build-system complexity all reduced scrutiny.
...
!!! tip "Trust Should Be Earned Incrementally"

    Level 1: All PRs require maintainer review, no merge access. Level 2 (after months of contributions): Can merge own PRs after approval. Level 3 (after sustained quality): Can review others' PRs. Level 4 (after years): Full maintainer access.
...
- Over roughly two years, the attacker gained commit access and maintainer-like authority
- Malicious code was hidden in test fixtures and build system
- Backdoor would have affected `sshd` on some Linux distributions where OpenSSH was patched for systemd integration, which pulled in `liblzma`
