---
title: "Security Practices for Project Maintainers"
description: "Your project becomes part of other people's software—implement solid security practices with free platform features and clear frameworks without becoming a security expert."
icon: "lucide/shield"
---

# 24.1 Security Practices for Project Maintainers

!!! info "Maintainers Shape the Supply Chain"

    Your project—whether downloaded a hundred times or a hundred million times—becomes part of other people's software. This creates responsibility to users who depend on your code's security, and opportunity to demonstrate practices that build trust and protect the broader ecosystem.
...
Before examining security practices for maintainers, we must clarify a foundational point: **maintainers providing code under open source licenses, without compensation, have no obligation to anyone**[^not-a-supplier]. The legal disclaimers in open source licenses are not legal fiction—they accurately reflect that unpaid volunteers are providing gifts to the commons, not services to consumers.

When we discuss "maintainer responsibilities" in security contexts, we refer to practices that improve security outcomes, not obligations maintainers owe. The genuine obligation runs the other direction: organizations deriving commercial value from open source code bear responsibility for the security of products they sell. They chose to incorporate unpaid volunteers' code into their commercial offerings; the consequences of that choice are theirs.

Effective governance recognizes this asymmetry and focuses intervention on the entities with resources and commercial incentives, not on the volunteers who created value they are sharing freely. When enterprises pressure maintainers for faster security fixes on projects those enterprises use for free, they have the relationship backwards. The maintainer gave a gift; the enterprise built a business on it. The enterprise can contribute resources, hire the maintainer, or fork the project—but demanding unpaid labor is neither fair nor sustainable.

This section describes practices that maintainers *may choose* to adopt because they improve security outcomes for the ecosystem. These are recommendations, not requirements. A maintainer who implements none of them has not failed any obligation—they simply chose not to provide additional free services beyond the code itself.

The good news is that implementing solid security practices doesn't require a security team or extensive resources. Modern platforms like GitHub and GitLab provide free security features that automate much of the work. Frameworks like the OpenSSF Best Practices Badge[^openssf-badge] provide clear guidance on what to implement and how. This section provides practical, actionable guidance for maintainers who want to secure their projects without becoming security experts.
...
!!! tip "Machine-Readable Support Information"

    The OpenSSF Security Insights specification provides a standardized, machine-readable way to communicate your support model, security practices, and project status. Tools and platforms can parse this to help users make informed dependency decisions.

The OpenSSF Security Insights specification[^security-insights-spec] provides a standardized, machine-readable way to communicate your support model, security practices, and project status. Tools and platforms can parse this file to help users make informed decisions about depending on your project.
...
security-artifacts:
  ...
  self-assessment:
    ...
    - name: "OpenSSF Best Practices Badge"
      ...
      url: "https://www.bestpractices.dev/projects/XXXX"
      achieved: true
...
Several platforms and frameworks provide visibility into project security practices:

- **CLOMonitor**[^clomonitor]: CNCF project monitoring dashboard
- **LFX Insights**[^lfx-insights]: Linux Foundation metrics
- **OSPS Baseline**[^osps-baseline]: OpenSSF's [OSPS Baseline][osps-baseline-site] defines a comprehensive set of security requirements covering access control, build/release practices, vulnerability management, and more

The OSPS Baseline defines specific, verifiable security controls organized by maturity level (1-3). Using the Baseline as a checklist helps identify gaps and provides a roadmap for security improvements aligned with industry frameworks like SLSA, NIST SSDF, and the EU Cyber Resilience Act.
...
- OpenSSF Security Insights Specification[^security-insights-repo]
- Security Insights Examples[^security-insights-examples]
...
When in doubt, consult the CVSS calculator[^cvss-calculator] or ask the security research community.
...
| Sigstore[^sigstore-docs]/`Cosign` | Low | Keyless (identity-based) | `cosign verify` |
...
The OpenSSF Best Practices Badge[^openssf-badge-criteria] provides a framework for evaluating and improving project security practices. Pursuing the badge systematically improves your security posture.
...
[^openssf-badge]: OpenSSF, "Best Practices Badge," https://www.bestpractices.dev/

[^security-insights-spec]: OpenSSF, "Security Insights Specification," https://github.com/ossf/security-insights-spec

[^clomonitor]: CNCF, "CLOMonitor," https://clomonitor.io/

[^lfx-insights]: Linux Foundation, "LFX Insights," https://insights.lfx.linuxfoundation.org/

[^osps-baseline]: OpenSSF, "Open Source Project Security Baseline," https://github.com/ossf/security-baseline

[osps-baseline-site]: https://baseline.openssf.org/

[^security-insights-repo]: OpenSSF, "Security Insights Specification Repository," https://github.com/ossf/security-insights-spec

[^security-insights-examples]: OpenSSF, "Security Insights Examples," https://github.com/ossf/security-insights-spec/tree/main/examples

[^yaml-lint]: YAML Lint, https://www.yamllint.com/

[^cvss-calculator]: FIRST, "CVSS v4.0 Calculator," https://www.first.org/cvss/calculator/4.0

[^sigstore-docs]: Sigstore, "Documentation," https://docs.sigstore.dev/

[^openssf-badge-criteria]: OpenSSF, "Best Practices Badge," https://www.bestpractices.dev/

[^not-a-supplier]: Engard, B., "I Am Not a Supplier," Software Maxims, 2024, https://www.softwaremaxims.com/blog/not-a-supplier. — a widely-cited articulation of the position that open source maintainers are not in a supplier relationship with users of their code.
