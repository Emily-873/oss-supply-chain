---
title: "Accessing Resources and Support"
description: "Resources exist for all project sizes—from automated tools anyone can use to significant funding for critical projects to community mentorship open to all maintainers."
icon: "lucide/life-buoy"
---

# 24.6 Accessing Resources and Support

!!! info "Resources Exist for All Project Sizes"
...
The Open Source Security Foundation (OpenSSF)[^openssf] coordinates industry efforts to improve open source security. Several programs directly support maintainers.
...
[^alpha-omega-2024]: Alpha-Omega Project, "2024 Annual Report," January 2025, https://alpha-omega.dev/wp-content/uploads/sites/22/2025/01/Alpha-Omega-Annual-Report-2024_012925.pdf

**Scorecard**:

!!! tip "Free Automated Security Assessment"
...
Scorecard[^scorecard] automatically assesses open source project security practices and provides actionable improvement suggestions.
...
Allstar[^allstar] automatically enforces security best practices on GitHub repositories.
...
- **OpenSSF Best Practices Badge**[^openssf-badge]: Self-certification showing your project follows security best practices
- **Package Analysis**[^package-analysis]: Automated analysis of packages for malicious behavior
- **Security Insights**[^security-insights]: Standard format for publishing security information
- **OpenSSF Training**[^openssf-training]: Free security training courses
...
| **How to apply** | Projects apply through LFX Mentorship[^lfx-mentorship] platform |

**Other student and early-career programs**:

- **Outreachy**[^outreachy]: Internships for underrepresented groups in tech
- **MLH Fellowship**[^mlh-fellowship]: Programs that can include open source contribution
...
The Sovereign Tech Fund (STF)[^stf] is a German government-backed program, operated by the Sovereign Tech Agency, funding open digital base technologies.
...
|---------|---------|-------|
| **NGI (Next Generation Internet)**[^ngi] | EU | Internet technology, including security (check current funding status) |
| **NLnet Foundation**[^nlnet] | Netherlands | Open technology, privacy, security |
| **Mozilla Foundation grants**[^mozilla-fund] | Mozilla Foundation | Open technology and internet health; check current calls |
...
- **Sustain Podcast**[^sustain-podcast]: Interviews about open source sustainability
- **Open Source Collective**[^open-source-collective]: Community around OSC-hosted projects
- **LFX Mentorship**[^lfx-mentorship-platform]: Linux Foundation mentorship and funding platform

**Security-specific support**:

- **OpenSSF Slack**[^openssf-slack]: Community discussions on security
- **OWASP Chapters**[^owasp-chapters]: Local security communities
...
[^openssf]: OpenSSF, "Open Source Security Foundation," https://openssf.org/
...
[^package-analysis]: OpenSSF, "Package Analysis," https://github.com/ossf/package-analysis

[^security-insights]: OpenSSF, "Security Insights Specification," https://github.com/ossf/security-insights-spec

[^openssf-training]: OpenSSF, "Training," https://openssf.org/training/

[^gsoc]: Google, "Google Summer of Code: How It Works," https://summerofcode.withgoogle.com/how-it-works

[^lfx-mentorship]: Linux Foundation, "LFX Mentorship," https://mentorship.lfx.linuxfoundation.org/

[^outreachy]: Outreachy, https://www.outreachy.org/

[^mlh-fellowship]: MLH, "Open Source Fellowship," https://fellowship.mlh.io/programs/open-source

[^stf]: Sovereign Tech Agency, "Sovereign Tech Fund," https://www.sovereign.tech/programs/fund

[^ngi]: NGI, "Next Generation Internet," https://www.ngi.eu/

[^nlnet]: NLnet Foundation, https://nlnet.nl/

[^mozilla-fund]: Mozilla Foundation, "Grantmaking," https://www.mozillafoundation.org/en/what-we-do/grantmaking/
...
[^sustain-podcast]: Sustain OSS, "Sustain Podcast," https://podcast.sustainoss.org/

[^open-source-collective]: Open Collective, "Open Source Collective," https://opencollective.com/opensource

[^lfx-mentorship-platform]: Linux Foundation, "LFX Mentorship," https://mentorship.lfx.linuxfoundation.org/

[^openssf-slack]: OpenSSF, "OpenSSF Slack," https://slack.openssf.org/

[^owasp-chapters]: OWASP, "OWASP Chapters," https://owasp.org/chapters/
