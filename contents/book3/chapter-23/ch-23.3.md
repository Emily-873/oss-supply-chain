...
description: "Implement security champions programs that distribute supply chain security expertise throughout the organization."
icon: "lucide/trophy"
---

# 23.3 Security Champions Programs

!!! info "Security Teams Cannot Scale Alone"

    When one security engineer supports 100+ developers, there isn't enough bandwidth for hands-on involvement in every team's decisions. Supply chain decisions happen continuously across every development team—dependency selection, build configuration, deployment practices. Champions extend security reach.
...
!!! tip "Quality Over Quantity"
    ...
    A few engaged champions outperform many disengaged ones. Look for technical credibility, genuine interest in security, communication skills, and influence. Frame the opportunity positively: "Gain skills that advance your career while helping your team ship more securely."
...
[^champion-ratios]: OWASP Security Champions Guidebook, https://owasp.org/www-project-security-champions-guidebook/. The ranges here are practical planning targets for high-risk environments, not universal benchmarks. Actual ratios vary based on team structure, product risk profile, and organizational security maturity.

Organizations with high-risk products or regulatory requirements may need higher ratios. The OWASP Security Champions program[^owasp-security-champions] emphasizes adapting the model to organizational context rather than treating any single ratio as authoritative.
...
**Training curriculum for champions** (see OWASP Security Champions resources[^owasp-security-champions] and the OWASP Security Culture Project[^owasp-security-culture] for additional curriculum guidance):
...
| **Vulnerability response** | Triage automated vulnerability alerts (e.g., Dependabot[^dependabot], Snyk[^snyk]), guide remediation, track resolution | 2-3 hours/week |
...
- Managers whose reports serve as champions are held accountable for protecting champion time
...
**Illustrative scenario: Burnout intervention**:

> **Context**: Mid-size SaaS company, 400 developers, 35 champions
>
...
[^owasp-security-champions]: OWASP, "Security Champions Program," https://owasp.org/www-project-security-culture/v10/4-Security_Champions/

[^owasp-security-culture]: OWASP, "Security Culture Project," https://owasp.org/www-project-security-culture/
