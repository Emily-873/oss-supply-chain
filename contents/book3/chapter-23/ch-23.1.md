---
title: "Supply Chain Security Awareness Programs"
description: "Design, deliver, and measure supply chain security training programs that create lasting behavior change."
icon: "lucide/megaphone"
---

# 23.1 Supply Chain Security Awareness Programs

!!! info "Security Depends on Human Decisions"

    The most sophisticated scanning tools are undermined when a developer copies code from Stack Overflow without considering its origins, or when an engineer disables certificate verification to "get things working." Humans make better decisions when they understand threats, recognize risks, and have skills to respond.
...
| AI tools | Hallucination risks, validation | How to safely use GitHub Copilot/Amazon Q Developer |
...
!!! tip "Combine Multiple Methods"
    ...
    E-learning alone creates compliance checkboxes, not behavior change. Combine self-paced modules for baseline knowledge with live workshops for hands-on skills. Add tabletop exercises for incident response practice and embedded training for just-in-time learning.
...
- Updated PyPI digital attestation examples
...
|----------|------|------|----------|
| OpenSSF Secure Software Development[^openssf-training] | Course series | Free | Developer fundamentals |
| OWASP Application Security Curriculum[^owasp-curriculum] | Various | Free | Web security, secure coding |
| Snyk Learn[^snyk-learn] | Interactive lessons | Free | Vulnerability-specific training |
| SAFECode Training[^safecode-training] | Courses | Free | Secure development lifecycle |
| SANS DEV Courses[^sans-courses] | Intensive courses | Paid | Deep technical skills |
...
**Industry benchmarks**: External awareness reports and vendor ROI studies can provide useful context, but avoid treating them as universal benchmarks. Use them to frame assumptions, then validate impact against your own incident, remediation, and compliance data.[^training-roi-benchmarks]

[^training-roi-benchmarks]: SANS Institute, "2025 Security Awareness Report," https://www.sans.org/for-organizations/workforce/resources/security-awareness-report. Also see KnowBe4, "Security Awareness Training ROI," https://www.knowbe4.com/resources/security-awareness-training-roi/.

[^openssf-training]: OpenSSF, "Secure Software Development Training Courses," https://openssf.org/training/courses/

[^owasp-curriculum]: OWASP, "Application Security Curriculum," https://owasp.org/www-project-application-security-curriculum/

[^snyk-learn]: Snyk, "Snyk Learn," https://learn.snyk.io/

[^safecode-training]: SAFECode, "Security Training Resources," https://safecode.org/training/

[^sans-courses]: SANS Institute, "Cyber Security Courses," https://www.sans.org/cyber-security-courses/
