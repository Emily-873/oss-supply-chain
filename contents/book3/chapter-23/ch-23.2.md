---
title: "Building Supply Chain Security Expertise"
description: "Develop deep supply chain security skills through structured learning paths, mentorship, and community engagement."
icon: "lucide/brain"
---

# 23.2 Building Supply Chain Security Expertise

!!! info "Expertise Is Scarce"

    Supply chain security spans traditional boundaries between security, development, and operations. Someone who understands vulnerability management may not understand build systems; someone who knows CI/CD may not recognize attack patterns. Building genuine expertise requires intentional development across multiple domains.
...
|----------|------|-------|-------|
| OpenSSF Courses[^openssf-courses] | Free courses | Secure development fundamentals | Beginner-Intermediate |
| SLSA Specification[^slsa-spec] | Documentation | Build integrity framework | Intermediate |
| Sigstore Documentation[^sigstore-docs] | Documentation | Signing and verification | Intermediate |
| Package Analysis Project[^package-analysis] | Open source | Malicious package detection | Advanced |
| in-toto Specification[^in-toto-spec] | Documentation | Supply chain integrity | Advanced |
| Securing the Software Supply Chain (CISA)[^cisa-guide] | Guide | Comprehensive practices | All levels |

**Hands-on practice recommendations**:

- **Contribute to security tooling**: Work on Sigstore[^sigstore], Trivy[^trivy], Syft[^syft], or similar projects
...
!!! tip "Mentorship Accelerates Learning"

    Expertise develops faster with guidance. Mentorship provides context that self-study cannot. Pair mentees with mentors based on goals and background, meet biweekly minimum, set clear learning objectives, and evaluate progress regularly.
...
|---------------------|-------|-------|
| **Open Source Summit**[^oss-summit] | Open source broadly, supply chain track | Community, emerging practices |
| **KubeCon/CloudNativeCon**[^kubecon] | Cloud native, supply chain security focus | Technical depth, tooling |
| **Black Hat**[^blackhat]/**DEF CON**[^defcon] | Security broadly, supply chain talks | Attack research, threat landscape |
| **BSides events**[^bsides] | Regional security | Accessible, community-focused |
| **OpenSSF Community**[^openssf-community] | Supply chain security specifically | Standards, collaboration |
| **OWASP**[^owasp] | Application security | Practices, tools, community |

**Online communities**:

- **OpenSSF Slack**[^openssf-slack]: Active discussion of supply chain security topics
- **CNCF Slack**[^cncf-slack]: Cloud native security channels
...
|-------------|------|-------|
| OpenSSF Blog[^openssf-blog] | Blog | Standards, initiatives |
| Sigstore Blog[^sigstore-blog] | Blog | Signing ecosystem updates |
| Snyk Blog[^snyk-blog] | Blog | Vulnerability research |
| Sonatype Blog[^sonatype-blog] | Blog | Supply chain research |
| The New Stack[^new-stack] | Publication | Cloud native news |

**Research and reports** (seek most recent editions):

- Sonatype State of the Software Supply Chain[^sonatype-report] (annual)
- Snyk State of Open Source Security[^snyk-report] (annual)
- Synopsys Open Source Security and Risk Analysis[^synopsys-report] (annual)
- OpenSSF publications and specifications[^openssf-resources]
...
[^openssf-courses]: OpenSSF, "Training Courses," https://openssf.org/training/courses/

[^slsa-spec]: SLSA, "Supply-chain Levels for Software Artifacts," https://slsa.dev/

[^sigstore-docs]: Sigstore, "Documentation," https://docs.sigstore.dev/

[^package-analysis]: OpenSSF, "Package Analysis Project," https://github.com/ossf/package-analysis

[^in-toto-spec]: in-toto, "A Framework for Supply Chain Integrity," https://in-toto.io/

[^cisa-guide]: CISA, "Securing the Software Supply Chain: Recommended Practices Guide for Developers," https://www.cisa.gov/sites/default/files/publications/ESF_SECURING_THE_SOFTWARE_SUPPLY_CHAIN_DEVELOPERS.PDF

[^sigstore]: Sigstore, "Software Signing for Everyone," https://www.sigstore.dev/

[^trivy]: Aqua Security, "Trivy," https://trivy.dev/

[^syft]: Anchore, "Syft," https://github.com/anchore/syft

[^oss-summit]: Linux Foundation, "Open Source Summit North America," https://events.linuxfoundation.org/open-source-summit-north-america/

[^kubecon]: CNCF, "KubeCon + CloudNativeCon Events," https://www.cncf.io/kubecon-cloudnativecon-events/

[^blackhat]: Black Hat, https://blackhat.com/

[^defcon]: DEF CON, https://defcon.org/

[^bsides]: Security BSides, https://bsides.org/

[^openssf-community]: OpenSSF, "Community," https://openssf.org/community/

[^owasp]: OWASP, "Open Worldwide Application Security Project," https://owasp.org/

[^openssf-slack]: OpenSSF, "Get Involved," https://openssf.org/getinvolved/

[^cncf-slack]: CNCF, "Cloud Native Slack," https://cloud-native.slack.com/

[^openssf-blog]: OpenSSF, "Blog," https://openssf.org/blog/

[^sigstore-blog]: Sigstore, "Blog," https://blog.sigstore.dev/

[^snyk-blog]: Snyk, "Blog," https://snyk.io/blog/

[^sonatype-blog]: Sonatype, "Blog," https://blog.sonatype.com/

[^new-stack]: The New Stack, https://thenewstack.io/

[^sonatype-report]: Sonatype, "State of the Software Supply Chain," https://www.sonatype.com/state-of-the-software-supply-chain

[^snyk-report]: Snyk, "State of Open Source Security Reports," https://snyk.io/reports/

[^synopsys-report]: Synopsys, "Open Source Security and Risk Analysis Report," https://www.synopsys.com/software-integrity/resources/analyst-reports/open-source-security-risk-analysis.html

[^openssf-resources]: OpenSSF, "Resources," https://openssf.org/resources/
