---
title: "Financial Services Supply Chain Controls"
description: "Financial services has the most mature third-party risk management frameworks—DORA creates comprehensive ICT requirements that other sectors are only beginning to consider."
...
!!! info "DORA: Most Comprehensive ICT Risk Framework"
    The EU's Digital Operational Resilience Act (effective January 2025) creates mandatory ICT third-party risk management, contractual requirements, critical provider oversight, and concentration risk management for financial entities—the most comprehensive regulatory framework addressing technology supply chain risks in any sector.
...
- The `npm` registry hosts most public JavaScript packages, even when accessed through alternative package managers like Yarn or pnpm
- A few build systems dominate (`GitHub Actions`, `GitLab CI`)
- Core libraries (`OpenSSL`, `Log4j`) are widely used dependencies
- Single points of failure exist throughout

!!! warning "Software Has Severe Concentration Risk"
    npm hosts most public JavaScript packages. A few build systems dominate CI/CD. Core libraries like OpenSSL and Log4j are widely used dependencies. Financial regulators require concentration risk assessment—software supply chains exhibit exactly the risks they're worried about.
...
- **Governance platforms**: OWASP Dependency-Track[^dependency-track]
