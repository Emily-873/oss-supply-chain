...
description: "Automotive tiered supplier management creates cascading accountability—OEMs manage Tier 1 who manage Tier 2. Software's flat dependencies have no equivalent structure."
icon: "lucide/car"
---
...
!!! info "Automotive Tiers vs. Software's Flat Dependencies"
    Automotive OEMs manage Tier 1 suppliers who manage Tier 2 and so on—creating cascading accountability. Software applications directly depend on hundreds of packages with no intermediate management, no contractual relationships, and no flow-down of security requirements.
...
- Remediation, owner notification, dealer labor, and logistics create direct financial exposure
...
The EU CRA[^eu-cra] will create software recall equivalents through mandatory security update requirements and incident reporting as its obligations take effect. This represents movement toward automotive-style accountability.
...
!!! warning "UN R155/R156 Block Market Access Without Compliance"
    Vehicles cannot be sold in EU, UK, Japan, or South Korea without R155 (cybersecurity) and R156 (software updates) compliance. These regulations require Cybersecurity Management Systems, supply chain security, and software update management—providing a model for mandatory software security requirements.
...
EU CRA[^eu-cra] represents a similar approach for software generally—mandatory requirements with market access implications. The CRA entered into force in December 2024, with its main obligations applying from December 2027.
...
[^un-r156]: UNECE, "UN Regulation No. 156 - Software Update and Software Updates Management System," 2021, https://unece.org/transport/documents/2021/03/standards/un-regulation-no-156-software-update-and-software-updates-management-system
