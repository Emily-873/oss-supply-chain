---
title: "Patent Risks in Dependencies"
description: "Dependencies inherit patent exposure—a dependency implementing a patented algorithm creates infringement risk that transfers to every downstream user of your software."
...
!!! warning "Dependencies Inherit Patent Exposure"

    A dependency implementing a patented algorithm creates infringement risk that transfers to every downstream user. Unlike copyright—where open source licenses grant necessary rights—patent rights operate independently. A license to use code doesn't automatically include patent rights.
...
!!! tip "Apache 2.0 Includes Explicit Patent Grant"

    The Apache License includes an explicit patent grant covering patents necessarily infringed by contributors' contributions, alone or in combination with the work. MIT and BSD licenses lack explicit patent grants, creating greater uncertainty. Prefer Apache 2.0-licensed dependencies when patent exposure is a concern.
...
This grant covers patents necessarily infringed by contributors' contributions—alone or in combination with the work. However, it does not cover:

- Patents held by third parties unrelated to the project
- Unrelated functionality not necessarily infringed by the contributor's own contribution
- Patent claims the contributor does not have the right to license
...
Founded in 2005 by IBM, Sony, Philips, Red Hat, and Novell (now SUSE), OIN has grown to include thousands of members and covers patents related to the "Linux System"—a defined set of core open source packages.
...
|-----------------|-------------------|-------|
| Video codecs (H.264, H.265) | High | Patent pools and royalty requirements |
