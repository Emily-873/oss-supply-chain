---
title: "Criminal Liability for Intentional Attacks"
description: "Supply chain attacks are federal crimes—when attackers compromise build systems or inject malicious code, they violate multiple criminal statutes. Know when to involve law enforcement."
icon: "lucide/siren"
---

# 28.6: Criminal Liability for Intentional Attacks

!!! danger "Supply Chain Attacks Are Federal Crimes"

    When attackers compromise build systems, inject malicious code, or backdoor libraries, they potentially violate multiple criminal statutes. The conduct alleged in the SolarWinds campaign was not merely cybersecurity harm—it implicated criminal statutes that can be prosecuted under U.S. law. Know when to involve law enforcement.

Supply chain attacks are not merely security incidents—they are often serious federal crimes carrying substantial penalties. When attackers compromise a build system, inject malicious code into a trusted package, or backdoor a widely-used library, they potentially violate multiple criminal statutes at the federal and state level. The conduct alleged in the SolarWinds campaign was not merely cybersecurity harm; it implicated criminal statutes that can be prosecuted under U.S. law. Understanding the criminal legal framework helps organizations recognize when incidents warrant law enforcement involvement and how to cooperate effectively when they do.
...
The **Computer Fraud and Abuse Act (CFAA)**[^cfaa], 18 U.S.C. § 1030, provides the primary federal criminal framework for computer crimes. CFAA provisions applicable to supply chain attacks include:

- **§ 1030(a)(2)**[^cfaa]: Obtaining information from protected computers without authorization—applicable when attackers exfiltrate data through compromised software
...
- **Wire Fraud (18 U.S.C. § 1343)**[^wire-fraud]: Using wire communications to defraud—applicable when attacks involve deception for financial gain
- **Identity Theft (18 U.S.C. § 1028A)**[^identity-theft]: Aggravated identity theft adds mandatory 2-year consecutive sentences when attacks involve stolen credentials
- **Economic Espionage Act (18 U.S.C. §§ 1831-1839)**[^economic-espionage]: Applicable when attacks target trade secrets, particularly for foreign government benefit
- **Conspiracy (18 U.S.C. § 371)**[^conspiracy]: Conspiracy to commit computer fraud—enables prosecution of attack planners and facilitators
...
The **Council of Europe Convention on Cybercrime**[^budapest-convention] (Budapest Convention) provides the primary international framework for cybercrime cooperation. As of 2025, 81+ countries have ratified the convention, committing to:
...
Major supply chain attacks publicly attributed to nation-state actors (SolarWinds to Russia, various attacks to North Korea and China) can result in indictments that may never lead to arrests if defendants remain in countries without extradition arrangements.
...
DOJ's Computer Crime and Intellectual Property Section (CCIPS)[^ccips] and the National Security Division's Cyber Section (NatSec Cyber) focus on:
...
- **InfraGard**[^infragard]: Public-private partnership for infrastructure protection
- **Cyber Task Forces**: Multi-agency task forces in major metropolitan areas
- **CISA**[^cisa] **coordination**: CISA may facilitate FBI engagement for significant incidents
- **IC3 reporting**[^ic3]: Internet Crime Complaint Center for cyber-enabled crime reporting
...
The Crime Victims' Rights Act (CVRA)[^cvra] provides victims of federal crimes rights including:
...
- Restitution may have payment priority over fines, but collection depends on the defendant's assets and may be uncollectible
...
[^cfaa]: Cornell Law School, Legal Information Institute, "18 U.S.C. § 1030 - Fraud and related activity in connection with computers," https://www.law.cornell.edu/uscode/text/18/1030

[^wire-fraud]: Cornell Law School, Legal Information Institute, "18 U.S.C. § 1343 - Fraud by wire, radio, or television," https://www.law.cornell.edu/uscode/text/18/1343

[^identity-theft]: Cornell Law School, Legal Information Institute, "18 U.S.C. § 1028A - Aggravated identity theft," https://www.law.cornell.edu/uscode/text/18/1028A

[^economic-espionage]: Cornell Law School, Legal Information Institute, "18 U.S.C. § 1831 - Economic espionage," https://www.law.cornell.edu/uscode/text/18/1831

[^conspiracy]: Cornell Law School, Legal Information Institute, "18 U.S.C. § 371 - Conspiracy to commit offense or to defraud United States," https://www.law.cornell.edu/uscode/text/18/371

[^budapest-convention]: Council of Europe, "Convention on Cybercrime (Budapest Convention)," https://www.coe.int/en/web/cybercrime/the-budapest-convention

[^ccips]: U.S. Department of Justice, "Computer Crime and Intellectual Property Section," https://www.justice.gov/criminal/criminal-ccips

[^infragard]: InfraGard National, https://www.infragardnational.org/
...
[^cvra]: Cornell Law School, Legal Information Institute, "18 U.S.C. § 3771 - Crime victims' rights," https://www.law.cornell.edu/uscode/text/18/3771
