...
description: "Borderless software meets national regulation—code commits in Germany, reviewed in Japan, downloaded in 190 countries within hours collides with export control regimes."
...
!!! warning "Borderless Software Meets National Regulation"

    Open source flows across borders effortlessly—code from Germany, reviewed in Japan, downloaded in 190 countries within hours. This collides with export control regimes designed for physical goods. Understanding exceptions that protect most open source activity enables compliance.

This borderless nature of open source development collides uncomfortably with export control and sanctions regimes designed for a world of physical goods and identifiable transactions. When a cryptographic library is "exported" to a sanctioned country simply by being publicly available on GitHub, traditional export control concepts strain to apply.
...
The United States regulates export of encryption technology through the **Export Administration Regulations (EAR)**, administered by the Bureau of Industry and Security (BIS)[^bis] within the Department of Commerce. These regulations implement the **Wassenaar Arrangement**[^wassenaar], a multilateral export control regime with 42 participating countries coordinating controls on conventional arms and dual-use technologies.
...
**Publicly available source code treatment:**

Section 742.15(b) of the EAR[^ear-742-15] provides critical treatment for **publicly available encryption source code**. After the required notification, qualifying source code is not subject to the EAR, enabling public release of encryption source code that is:
...
This treatment enables open source cryptographic libraries, secure communication tools, and security software to be developed and distributed globally without individual export licenses.

**Notification requirement:**

For publicly available encryption source code, the EAR requires notification to BIS and NSA before or contemporaneously with public release. Developers must send an email to `crypt@bis.doc.gov` and `enc@nsa.gov` with:

- The public URL where the source code is available
- A brief description of the encryption functionality

This notification is informational—no response or approval is required. However, failure to notify can jeopardize the treatment that removes qualifying encryption source code from EAR controls.

**Object code considerations:**

The publicly available treatment applies explicitly to **source code**. Compiled object code (binaries) has historically received different treatment, though enforcement against publicly available compiled open source software has been minimal. Organizations distributing compiled cryptographic software should evaluate whether separate exceptions (such as mass market provisions) apply.
...
OFAC regulations[^ofac] include an exception for **informational materials**. However, it's important to note that 31 CFR 560.210(c)[^cfr-560-210] (for Iran) and similar provisions explicitly do **not** authorize "transactions incident to the exportation of software subject to the Export Administration Regulations." The informational materials exception covers certain publications and communications but does not extend to software that falls under EAR controls.

For open source software, public repository availability may be permissible under applicable exceptions, general licenses, or platform authorizations, but organizations should not assume that all sanctions restrictions disappear. They should understand the distinction:

- Making software publicly available (posting to GitHub, registries) may be permitted where applicable law or platform authorizations allow it
...
The **Specially Designated Nationals (SDN) List**[^sdn-list] identifies individuals and entities subject to sanctions regardless of location. Providing services to SDN-listed persons is prohibited, even if they reside in non-sanctioned countries.

For open source projects:

- Public availability alone is less likely to create SDN issues than targeted engagement
...
Organizations developing potentially dual-use software should conduct classification analysis before public release. While publicly available treatment protects much open source source-code distribution, certain categories may face restrictions even when source code is public.

**Entity list restrictions:**

The BIS **Entity List**[^entity-list] identifies organizations subject to specific export restrictions. Providing certain items to Entity List organizations requires a license, with presumption of denial for many entries.
...
GitHub[^github-trade-controls] implements trade-control compliance while trying to keep public repository services available where legally permitted. GitHub states that GitHub.com cloud services are available to developers in Iran and Cuba, while access may be restricted for Specially Designated Nationals, denied or blocked parties, certain government officials, and prohibited end uses. GitHub Enterprise Server and other commercial offerings remain subject to export restrictions for Country Group E:1 destinations and certain regions of Ukraine. Restrictions may include:
...
1. **BIS notification**: Send notification emails for qualifying encryption source code—this takes minutes and creates a compliance record
...
- Relying on publicly available treatment for source code and applicable sanctions exceptions or licenses
...
2. **File BIS notifications** for qualifying open source encryption source code—this simple step establishes compliance baseline

3. **Ensure genuine public availability** of open source releases, avoiding access restrictions that could undermine favorable export-control treatment
...
Export control and sanctions compliance adds complexity to international open source development. However, publicly available treatment for source code and applicable sanctions exceptions or licenses protect much ordinary open source activity, enabling continued global collaboration within legal boundaries.

[^bis]: Bureau of Industry and Security, U.S. Department of Commerce, https://www.bis.doc.gov/

[^wassenaar]: Wassenaar Arrangement on Export Controls for Conventional Arms and Dual-Use Goods and Technologies, https://www.wassenaar.org/

[^ear-742-15]: Cornell Law School, Legal Information Institute, "15 CFR 742.15 - Encryption items," https://www.law.cornell.edu/cfr/text/15/742.15

[^ofac]: Office of Foreign Assets Control, U.S. Department of the Treasury, https://ofac.treasury.gov/

[^cfr-560-210]: Cornell Law School, Legal Information Institute, "31 CFR 560.210 - Prohibited exportation, reexportation, sale, or supply of goods, technology, or services to Iran," https://www.law.cornell.edu/cfr/text/31/560.210

[^sdn-list]: OFAC, "Specially Designated Nationals and Blocked Persons List (SDN) Search," https://sanctionssearch.ofac.treas.gov/

[^entity-list]: Bureau of Industry and Security, "Entity List," https://www.bis.gov/entity-list

[^github-trade-controls]: GitHub, "GitHub and Trade Controls," https://docs.github.com/en/site-policy/other-site-policies/github-and-trade-controls
