---
title: "Liability Landscape for Software Supply Chains"
description: "The liability framework is shifting—EU CRA imposes manufacturer obligations; EU product-liability rules now include software; U.S. policy calls for reform."
icon: "lucide/gavel"
---
...
!!! warning "Liability Framework Is Shifting"

    The EU CRA imposes mandatory manufacturer cybersecurity obligations, and revised EU product-liability rules now include software. U.S. policy documents call for liability reform. Prepare for increased liability exposure.
...
Product liability law traditionally applies to **tangible goods** that cause physical harm. Manufacturers face **strict liability**—liability without fault—for defective products that injure users, regardless of due care exercised during manufacture. The question of whether software constitutes a "product" subject to these doctrines remains contested in many jurisdictions, though EU law now expressly includes software within its product-liability framework.
...
Some courts, particularly in cybersecurity and data-breach contexts, have allowed negligence claims to proceed where plaintiffs plausibly allege a duty to protect reasonably foreseeable users. The scope of this duty—and whether it extends through supply chains—remains an evolving area of law.
...
- Voluntary frameworks (NIST SSDF[^nist-ssdf], OWASP SCVS[^owasp-scvs]) adopted by industry
- Representations made by the vendor about security

As frameworks like NIST SSDF[^nist-ssdf] and OWASP SCVS[^owasp-scvs] gain adoption, they increasingly define what "reasonable care" means for software development. Failure to follow widely-adopted security practices may support negligence claims.

**Dependency selection** creates specific duty of care questions.

!!! tip "Document Dependency Security Evaluation"

    Did you exercise reasonable care in selecting components? Did you evaluate security before adoption? Did you monitor for vulnerabilities? Organizations with documented security evaluation processes may demonstrate reasonable care even when vulnerabilities occur.

When you incorporate a third-party component into your software:
...
**EU Cyber Resilience Act and Product Liability**

The EU Cyber Resilience Act[^eu-cra] fundamentally shifts regulatory responsibility for software security within the EU. Key obligations and enforcement features include:

- **Manufacturer obligations**: Manufacturers must meet essential cybersecurity requirements before placing products with digital elements on the EU market
- **Vulnerability handling**: Manufacturers must provide security updates and handle vulnerability reporting during the support period
- **Market surveillance and penalties**: Authorities can require corrective action and impose penalties for non-compliance
- **Civil-liability interaction**: CRA non-compliance may become evidence in civil claims under contract, tort, or product-liability theories

Warranty disclaimers will not avoid CRA regulatory obligations. They also may not defeat mandatory civil-liability regimes where those regimes apply, so organizations should not assume "as-is" language is sufficient for software placed on the EU market.

The **EU Product Liability Directive revision** (2024)[^eu-pld] complements the CRA by explicitly including software as a "product" subject to no-fault product liability when defective products cause covered damage. Together, these measures create a more comprehensive accountability regime for software security failures.

**U.S. Policy Direction**

While the U.S. lacks legislation equivalent to the CRA, policy documents signal shifting expectations:

The **2023 National Cybersecurity Strategy**[^national-cyber-strategy] explicitly calls for liability reform:
...
The **CISA Secure by Design initiative**[^cisa-secure-by-design] establishes voluntary principles that may inform future liability standards. Adoption of these principles may demonstrate reasonable care; rejection may support negligence claims.
...
- Increase premiums or change terms at renewal following claims
...
[^nist-ssdf]: NIST, "Secure Software Development Framework (SSDF) Version 1.1," SP 800-218, https://csrc.nist.gov/pubs/sp/800/218/final

[^owasp-scvs]: OWASP, "Software Component Verification Standard," https://scvs.owasp.org/

[^eu-cra]: European Commission, "Cyber Resilience Act," https://digital-strategy.ec.europa.eu/en/policies/cyber-resilience-act

[^eu-pld]: European Union, "Directive (EU) 2024/2853 on liability for defective products," https://eur-lex.europa.eu/eli/dir/2024/2853/oj/eng

[^national-cyber-strategy]: The White House, "National Cybersecurity Strategy," 2023, https://bidenwhitehouse.archives.gov/wp-content/uploads/2023/03/National-Cybersecurity-Strategy-2023.pdf

[^cisa-secure-by-design]: CISA, "Secure by Design," https://www.cisa.gov/securebydesign
