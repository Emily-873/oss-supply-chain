---
title: "Regional Ecosystems and Platforms"
description: "Regional alternatives emerge as governments seek digital sovereignty—China's Gitee and OpenAtom Foundation show how regional ecosystems can grow. What happens when the world fragments?"
icon: "lucide/map"
---
...
[**Gitee**][gitee] (gitee.com), operated by Open Source China (OSChina), serves as China's primary alternative to GitHub. The platform describes itself as serving millions of developers and hosting a large repository base,[^gitee-stats] making it one of the largest code hosting platforms outside the Western ecosystem.

[^gitee-stats]: Gitee public platform descriptions and homepage materials. See https://gitee.com/ and https://gitee.com/about_us for current information. Growth accelerated significantly after 2019.
...
!!! info "China's Parallel Open Source Ecosystem"
    Gitee serves millions of developers and hosts a large repository base. Combined with the OpenAtom Foundation (hosting OpenHarmony and openEuler), China has built the most comprehensive regional alternative to the U.S.-dominated open source infrastructure.
...
[^openatom-founding]: OpenAtom Foundation, "About Us," https://www.openatom.org/ (established June 2020 with support from the Ministry of Industry and Information Technology as China's first open source foundation).
...
**OpenHarmony** represents China's most significant domestic operating system effort. Originally developed by Huawei after U.S. restrictions limited its access to Google Mobile Services and other parts of the commercial Android ecosystem, OpenHarmony is now an OpenAtom Foundation project with contributions from multiple Chinese technology companies.

OpenHarmony characteristics:

- **Microkernel-oriented design**: Uses a kernel abstraction rather than being a direct Android fork
...
- [**GitFlic**][gitflic]: Russian code hosting platform developed by ReSolut LLC
...
- Some global services, payment flows, and account features became less accessible or legally uncertain
...
- [**CERN**][cern]: Historic open source contributions including inventing the World Wide Web and releasing its underlying software into the public domain in 1993
...
[nlnet]: https://nlnet.nl/commonsfund/
