---
title: "International Coordination and Divergence"
description: "Global software, fragmented regulation—software supply chains are inherently global, yet regulatory frameworks remain stubbornly national, creating a patchwork to navigate."
icon: "lucide/globe"
---
...
This tension between global software development and fragmented regulatory jurisdiction creates practical challenges for every participant in the software ecosystem. A maintainer in Brazil contributing to an open source project faces potential obligations under EU law if that software is incorporated into products sold in Europe through commercial activity. A U.S. software company may face agency-specific federal requirements and EU Cyber Resilience Act obligations. An Australian organization using software from multiple vendors confronts varying standards for supply chain security depending on where those vendors operate.
...
The U.S. approach relies primarily on procurement leverage, agency risk determinations, and voluntary frameworks. Executive Order 14028 initiated requirements for software sold to the federal government, but OMB M-26-05 rescinded the government-wide attestation mandate and left agencies to tailor requirements based on risk. NIST frameworks provide implementation guidance without mandatory force unless adopted by contract, regulation, or agency policy. Sector-specific regulators (FDA, NERC, TSA) impose binding requirements within their domains, but no horizontal product safety regulation comparable to the EU CRA exists.

This approach preserves flexibility and industry self-regulation while creating incentives through federal purchasing power where agencies choose to use them. However, it leaves consumer software markets largely unregulated and depends heavily on voluntary adoption of security practices.
...
Practitioner critiques offer a useful corrective to how the CRA is often framed. Ecosystem researcher Andrew Nesbitt argues the CRA is best understood as a product-safety law in the CE-mark family, in which open source appears only as exemptions, component risks, and compliance requirements—not as the regulation's subject.[^nesbitt-cra] On this reading, the heaviest obligations correctly fall on manufacturers, and maintainers face minimal direct duties; but the regulation also establishes no funding mechanism or maintenance support for the upstream projects manufacturers depend on. Nesbitt warns that the CRA's incentive structure may push manufacturers to reduce their component exposure rather than invest upstream—echoing corporate behavior when open source licensing first became a compliance risk. Whether the CRA strengthens or hollows out the commons it regulates will depend on choices manufacturers make that the regulation itself does not direct.
...
|-------------|-------------------|-------|---------------|-------------|
| United States | Procurement and agency risk requirements | Federal contractors | Agency-specific | Contract-based |
...
1. Implementing secure development practices aligned with NIST SSDF[^nist-ssdf] (supports U.S. attestation where agencies require it and substantially addresses CRA essential requirements)
2. Generating SBOMs in standardized formats (SPDX[^spdx] or CycloneDX) meeting NTIA minimum elements where requested and CRA requirements
...
[^nesbitt-cra]: Andrew Nesbitt, "The CRA is not about open source," July 1, 2026, https://nesbitt.io/2026/07/01/the-cra-is-not-about-open-source.html
