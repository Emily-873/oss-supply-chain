---
title: "NIST Frameworks and Guidance"
description: "Voluntary yet foundational—NIST frameworks carry no direct regulatory force, yet they underpin virtually every significant cybersecurity regulation and provide the 'how' that regulations leave unspecified."
...
!!! info "Voluntary Yet Foundational"

    NIST frameworks carry no direct regulatory force, yet they underpin virtually every significant cybersecurity regulation. When EO 14028 mandated secure development practices, it directed NIST to develop the criteria. NIST provides the "how" that regulations leave unspecified.
...
The **NIST Cybersecurity Framework (CSF)**[^nist-csf] has become the de facto standard for organizing cybersecurity programs since its initial release in 2014. Version 2.0, published in February 2024,[^nist-csf-2] significantly expands supply chain risk management from a subordinate consideration to a core governance function.

[^nist-csf-2]: NIST, "The NIST Cybersecurity Framework (CSF) 2.0," CSWP 29, February 2024, https://csrc.nist.gov/pubs/cswp/29/the-nist-cybersecurity-framework-csf-20/final
...
**NIST Special Publication 800-161 Revision 1**[^nist-sp-800-161], titled "Cybersecurity Supply Chain Risk Management Practices for Systems and Organizations," provides comprehensive guidance for establishing and operating a **Cybersecurity Supply Chain Risk Management (C-SCRM)** program. Published in May 2022,[^nist-800-161] it represents NIST's most detailed treatment of supply chain security.

[^nist-800-161]: NIST, "Cybersecurity Supply Chain Risk Management Practices for Systems and Organizations," SP 800-161 Rev. 1, May 2022, https://csrc.nist.gov/pubs/sp/800/161/r1/upd1/final
...
**NIST Special Publication 800-218**[^nist-sp-800-218], the **Secure Software Development Framework (SSDF)**, forms the technical foundation for EO 14028's software security attestation requirements. Version 1.1, published in February 2022,[^nist-800-218] defines a set of practices that software producers should adopt to mitigate vulnerabilities throughout the development lifecycle.
...
The SSDF was explicitly referenced in OMB M-22-18 (now rescinded by M-26-05) and remains referenced in the CISA Secure Software Development Attestation Form, which agencies may still choose to require.

Organizations attesting to secure development practices are effectively certifying SSDF implementation. We recommend organizations map their existing development practices to SSDF practices and tasks, identifying gaps that require remediation before attestation.
...
**NIST IR 8397**[^nist-ir-8397], "Guidelines on Minimum Standards for Developer Verification of Software," addresses how organizations should verify software they develop or acquire—including verification of SBOM accuracy and completeness.
...
NIST's **National Vulnerability Database (NVD)**[^nist-nvd] increasingly supports SBOM-based vulnerability management by providing vulnerability data in machine-readable formats that can be matched against SBOM component identifiers.

## AI Risk Management Framework and Supply Chain

The **NIST AI Risk Management Framework (AI RMF)**[^nist-ai-rmf], published in January 2023, addresses risks specific to artificial intelligence systems. As AI components become increasingly prevalent in software products, their supply chain implications require attention.
...
[^nist-csf]: NIST, "The NIST Cybersecurity Framework (CSF) 2.0," CSWP 29, February 2024, https://csrc.nist.gov/pubs/cswp/29/the-nist-cybersecurity-framework-csf-20/final

[^nist-sp-800-161]: NIST, "Cybersecurity Supply Chain Risk Management Practices for Systems and Organizations," SP 800-161 Rev. 1, May 2022, https://csrc.nist.gov/pubs/sp/800/161/r1/upd1/final

[^nist-sp-800-218]: NIST, "Secure Software Development Framework (SSDF) Version 1.1," SP 800-218, February 2022, https://csrc.nist.gov/pubs/sp/800/218/final

[^nist-ir-8397]: NIST, "Guidelines on Minimum Standards for Developer Verification of Software," IR 8397, https://csrc.nist.gov/pubs/ir/8397/final

[^nist-nvd]: NIST, National Vulnerability Database (NVD), https://nvd.nist.gov

[^nist-ai-rmf]: NIST, "AI Risk Management Framework," January 2023, https://www.nist.gov/itl/ai-risk-management-framework
