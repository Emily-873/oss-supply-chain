...
The FDA's **Premarket Cybersecurity Guidance**[^fda-cybersecurity] (updated June 2025, superseding the September 2023 guidance) sets expectations for cyber device premarket submissions, including that manufacturers:
...
The SBOM requirement is particularly significant—FDA expects SBOMs in machine-readable, standardized formats such as SPDX, CycloneDX, or SWID as part of premarket submissions for cyber devices.
...
| Pipelines | TSA Directives | Emerging | TSA inspections | Yes (TSA directives have required reporting to CISA within 12 hours) |
| Defense | CMMC, DFARS | Emerging | C3PAO for some Level 2; government-led for Level 3 | Yes (72 hours) |
