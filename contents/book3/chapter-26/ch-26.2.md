...
description: "Global reach with significant penalties—the CRA applies to any organization placing software products on the European market, with fines up to EUR 15 million or 2.5% of global turnover."
icon: "lucide/flag"
---
...
!!! danger "Global Reach with Significant Penalties"

    The CRA applies to any organization placing software products on the European market, regardless of where they're headquartered. Penalties reach up to EUR 15 million or 2.5% of global annual turnover. Non-commercial open source is excluded, but commercial distribution triggers obligations.
...
The CRA emerged from the EU's broader cybersecurity strategy, responding to the same supply chain security concerns that prompted U.S. Executive Order 14028. ENISA's annual Threat Landscape reports[^enisa-etl] document the growing risk: the 2025 report analyzed nearly 4,900 cybersecurity incidents and identified supply chain compromise as a persistent vector, with state-linked attacks targeting IT service providers and software repositories to achieve cascading effects across ecosystems. The European approach differs fundamentally from the U.S. mechanism: rather than procurement requirements, the CRA uses product safety regulation, treating insecure software as analogous to unsafe physical products that cannot legally be sold. This approach—backed by significant penalties of up to EUR 15 million or 2.5% of global annual turnover[^cra-summary]—ensures uniform application across the entire European market.
...
- Pure Software as a Service (SaaS) offerings, unless they qualify as remote data processing solutions for a product with digital elements; SaaS providers may instead face obligations under NIS2 where they meet that directive's scope
...
**Actively exploited vulnerabilities** must be reported through the CRA's single reporting platform to the CSIRT designated as coordinator and to the European Union Agency for Cybersecurity (ENISA)[^enisa] within **24 hours** of the manufacturer becoming aware that a vulnerability is being actively exploited.

!!! warning "24-Hour Notification Challenge"

    Many organizations currently take days or weeks to confirm exploitation status. The CRA's timeline demands rapid internal escalation procedures, pre-established reporting channels, and potentially 24/7 security operations capability.

This initial notification must include:
...
A more detailed vulnerability notification must follow within **72 hours**, and a final vulnerability report within **14 days** of making a corrective or mitigating measure available.

**Severe incidents** affecting product security must also be notified through the single reporting platform within **24 hours**, with a follow-up incident notification within **72 hours** and a final report within **one month** after the incident notification.

The 24-hour notification window proves particularly challenging. Many organizations currently take days or weeks to confirm exploitation status and perform initial analysis. The CRA's timeline demands rapid internal escalation procedures, pre-established reporting channels, and potentially 24/7 security operations capability.
...
- Facilitate good-faith reporting and coordinated disclosure

Beyond regulatory notification, manufacturers must inform affected users about security vulnerabilities and provide remediation guidance without undue delay.
...
A company that develops open source software as part of its business and places it on the EU market under its name or trademark—even if the software itself is free—must comply with CRA requirements as a manufacturer.
...
!!! warning "SBOMs Are Non-Negotiable for CRA Compliance"
    The SBOM requirement deserves emphasis: organizations without comprehensive SBOMs will find CRA compliance virtually impossible. The CRA's vulnerability management, incident reporting, and transparency requirements all depend on knowing what components are in your products. Organizations that have not invested in SBOM generation and dependency tracking should treat this as an urgent prerequisite for 2027 compliance.
...
**Critical products** (smart cards, secure elements, hardware security modules) may be required by Commission delegated act to obtain European cybersecurity certification under the EU Cybersecurity Act framework. Where no such delegated act applies, they follow the CRA's specified conformity assessment procedures for critical products.
...
The staggered timeline provides industry with transition periods, but the vulnerability reporting deadline arrives relatively quickly. Organizations must establish CRA notification capabilities and internal escalation procedures within 21 months.

The December 2027 deadline for full compliance means products placed on the EU market after that date must satisfy all essential requirements, bear CE marking, and be supported by complete technical documentation. Products placed on the market before this deadline are subject to the CRA's requirements only if they undergo a substantial modification from that date, although the Article 14 reporting obligations apply to in-scope products already placed on the market.
...
- Products may need an **authorized representative** established in the EU, particularly where the manufacturer has no EU establishment and uses one to perform CRA tasks
...
8. Establish CRA notification capabilities before September 2026
...
[^cra-annex-iii]: Regulation (EU) 2024/2847, "Annex III: Important Products with Digital Elements," https://eur-lex.europa.eu/eli/reg/2024/2847/oj
