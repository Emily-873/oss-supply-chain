---
title: "Models for Sustainable Security Investment"
description: "Various models address market failures—foundations aggregate resources, corporate teams dedicate engineers, industry consortia pool expertise. Each overcomes specific barriers to investment."
...
- **[Internet Bug Bounty][ibb]**: Corporate-funded bounties for core internet infrastructure and free open source software
...
These programs create structured channels for rewarding open source vulnerability discovery and remediation. However, bounty levels are typically lower than corporate programs, limiting researcher interest. As discussed in Chapter 15 on security testing, bug bounties complement but don't replace systematic security practices.
...
[Alpha-Omega][alpha-omega], launched by OpenSSF in February 2022, combines:

- Foundation governance (OpenSSF)
- Corporate funding (initial commitments from Google, Microsoft, Amazon, and Citi)
- Direct project engagement (dedicated engineers)
- Both targeted (Alpha) and broad (Omega) investment

As of 2024, Alpha-Omega distributed nearly $6 million in grants supporting 10 major open source projects[^alpha-omega-impact]. This hybrid draws on foundation neutrality, corporate resources, and direct technical engagement.

[^alpha-omega-impact]: OpenSSF Alpha-Omega Project, 2024 impact reporting (https://alpha-omega.dev/).
...
Germany's [Sovereign Tech Fund, now operating as the Sovereign Tech Agency][stf], represents government investment in open source infrastructure:
...
[^ostif-funding]: OSTIF, "About Us," https://ostif.org/about/. OSTIF reports approximately $1.5 million per year in audit funding, having facilitated over 12,000 hours of security work and found over 800 vulnerabilities across 150+ projects since 2016.
...
[osv]: https://osv.dev
[ibb]: https://docs.hackerone.com/en/articles/8312814-august-2023-changelog
