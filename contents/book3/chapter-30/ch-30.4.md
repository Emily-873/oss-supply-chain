---
title: "Government Funding and Public-Private Partnerships"
description: "If open source is public infrastructure, should public funds support its security? Governments increasingly answer yes—Germany's Sovereign Tech Fund demonstrates effective models."
...
Germany's **Sovereign Tech Fund (STF)**, now operating as the **[Sovereign Tech Agency][stf]**, was launched in 2022 and represents the most ambitious government investment specifically dedicated to open source infrastructure. Funded by the German Federal Ministry for Economic Affairs and Climate Action, the STF invests in "digital infrastructure that society relies on."
...
!!! info "The Sovereign Tech Fund Model"
    Germany's STF demonstrates that government can fund open source without controlling it. Maintainers receive resources; government receives improved infrastructure. No strings attached, no control requirements—just public investment in public goods.
...
- **EU-FOSSA pilot (2015-2016)**: Funded audits of KeePass and Apache HTTP Server
- **EU-FOSSA 2 (2017-2020)**: Funded audits and bug bounty programs for projects including VLC Media Player, Apache Kafka, PuTTY, Notepad++, FileZilla, 7-Zip, and Drupal
...
!!! warning "Security Agency Involvement Requires Scrutiny"
    The Dual EC DRBG controversy—where NSA promoted a random number generator later revealed to potentially contain a backdoor—damaged trust in agency cryptographic contributions. Agency involvement can be beneficial, but contributions require the same rigorous review as any other code.
...
!!! tip "Diversify Funding to Protect Independence"
    Projects accepting government funding should diversify across multiple sources to avoid dependence on any single funder. Foundations serve as valuable intermediaries, providing buffers between government funding and project governance.
...
[^stf-funding]: Sovereign Tech Agency, "FAQ," https://www.sovereign.tech/faq. Initial allocation was €3.5 million in 2022, growing to €11.5 million in 2023 and €17 million in 2024. Total investments exceed €24 million across 60+ projects.
...
[eu-fossa]: https://interoperable-europe.ec.europa.eu/collection/eu-fossa-2
