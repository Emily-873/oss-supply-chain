...
| **[NIST SP 800-161][NIST-800-161]** | Supply chain risk | Comprehensive; purpose-built | Critical suppliers, government contractors |
| **[NIST SP 1326 draft][NIST-SP-1326]** | Due diligence | Quick-start supplier risk assessment guidance | Acquirer due diligence for ICT suppliers |
...
## Applying Shared Responsibility to AI Vendors

AI vendor assessment needs a shared-responsibility model because a single AI-enabled product may combine a foundation model, hosted inference service, agent framework, third-party datasets, and your own application logic. CoSAI's AI Shared Responsibility Framework extends cloud shared-responsibility concepts to AI systems and emphasizes assigning one accountable party per activity across the AI stack.[^cosai-ai-srf] Use that model to replace the generic question "Is the AI system secure?" with more precise questions about which layer owns each control.

| Persona | What to demand or assess | What remains your responsibility |
|---------|--------------------------|----------------------------------|
| **Model provider** | Model provenance, intended-use documentation or model cards, security and safety validation, versioning, and vulnerability disclosure for the model | Selecting a model appropriate for your use case and compensating for documented limitations |
| **Platform or agentic framework provider** | Infrastructure isolation, IAM primitives, API security, logging, secure model serving, sandboxing, and controls around tool execution | Configuring those controls for your tenant, integrations, agents, and data flows |
| **Application developer** | Application guardrails, input validation, output filtering, user access controls, RAG and tool-permission design | Owning these controls when your teams build or customize the AI application |
| **Data provider** | Data quality, provenance, licensing, privacy handling, and classification evidence for training, evaluation, or inference data | Deciding what organizational data the AI system may access and minimizing sensitive data exposure |
| **Deploying organization / AI governance** | Evidence that vendors can support incident response, audit, and compliance obligations | Risk appetite, acceptable-use policy, user training, data classification, monitoring, compliance, and final risk acceptance |

This boundary-setting improves procurement conversations. We recommend asking a model provider for model lineage, known limitations, evaluation results, and disclosure practices; asking a platform or framework provider for isolation, logging, tool-execution, and service-level evidence; and reserving your own controls for data access, use-case approval, monitoring, and incident response. A vendor can support your governance program, but it cannot decide which customer records your chatbot may retrieve or which AI-generated decisions your organization is willing to accept.

[^cosai-ai-srf]: CoSAI, "AI Shared Responsibility Framework," V1.0, Workstream 2, 2026, https://www.coalitionforsecureai.org/wp-content/uploads/2026/05/CoSAI-Shared-Responsibility-Framework.pdf
...
| **Security certifications** | [OpenSSF Best Practices Badge][Best-Practices], SLSA provenance or conformance evidence | Industry-recognized maturity indicators |
...
[^cisa-sbd]: CISA, "Secure by Design Pledge," https://www.cisa.gov/securebydesign—a multinational initiative whose signatories commit to measurable security goals including MFA, reducing classes of vulnerabilities, vulnerability disclosure, CVE issuance, and security patching.
...
One category deserves scrutiny beyond what standard tiering suggests: security tooling vendors. Their products run inside CI/CD pipelines and on developer workstations with elevated access, and attackers have noticed. In 2026, attackers used credentials stolen in the [March 19 supply chain attack on the open source Trivy scanner to compromise Checkmarx's GitHub repositories][checkmarx-incident], then published malicious code through the vendor's VS Code extensions, GitHub Actions, Docker images, and a Jenkins plugin—channels that customers' pipelines consumed with the authority of a trusted security vendor. When evaluating security vendors, ask specifically how they secure their own artifact distribution channels, whether their extensions and actions are signed and pinnable, and how quickly they can notify customers of compromised releases.
...
[checkmarx-incident]: https://checkmarx.com/blog/ongoing-security-updates/
