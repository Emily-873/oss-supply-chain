...
**Regulatory expectations**: The SEC's 2023 cybersecurity disclosure rules require public companies to describe board oversight of cybersecurity risk, including "the board of directors' oversight of risks from cybersecurity threats" and management's role in assessing and managing material cyber risks. Supply chain security falls squarely within this scope. The EU's NIS2 Directive includes governance obligations for management bodies, and the Cyber Resilience Act imposes product security obligations that may require board-level attention.
...
**Investor expectations**: Institutional investors increasingly consider cybersecurity governance in investment decisions. Proxy advisory firms such as ISS and Glass Lewis incorporate cyber oversight into governance ratings. Supply chain security, as a systemic risk affecting multiple portfolio companies simultaneously, receives particular attention.
...
├── Budget request for SBOM tooling ($[amount])
├── Third-party security audit results (Attachment A)
└── Updated cyber insurance renewal terms (Attachment B)

PEER COMPARISON:
├── Industry median MTTR: [benchmark] (we are at 4.2 days)
├── SBOM adoption: [benchmark] (we are at 78%)
└── Vendor assessment coverage: [benchmark] (we are at 94%)
```
