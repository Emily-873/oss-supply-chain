---
title: "Open Source Consumption Policies"
description: "Governed use, not restricted use—effective policies balance developer productivity with security and legal requirements without creating friction that drives workarounds."
icon: "lucide/book-open"
---

# 25.3 Open Source Consumption Policies

!!! info "Governed Use, Not Restricted Use"

    The goal isn't to restrict open source—it's to ensure use is informed, intentional, and manageable. Without explicit policies, developers make independent decisions leading to inconsistent security, license compliance gaps, and unmaintained dependencies.
...
!!! tip "Proportional Approval by Risk"

    Not every dependency needs the same scrutiny. Auto-approve low-risk packages from approved lists. Require quick review for medium-risk. Mandate security team review for high-risk (new packages, security-sensitive areas). Reserve full evaluation for critical components.
