---
title: "Managing Commercial Software with Open Source Components"
description: "Commercial software often contains open source components—when Log4Shell emerged, organizations discovered Log4j embedded in commercial products from hundreds of vendors."
icon: "lucide/package-search"
---

# 25.4 Managing Commercial Software with Open Source Components

!!! warning "Commercial Software Contains Open Source"
...
The commercial software you purchase is rarely 100% proprietary. Industry analyses of commercial codebases consistently find widespread use of open source components [see [Black Duck OSSRA][OSSRA] and [Sonatype State of the Software Supply Chain][Sonatype-Report]]. When Log4Shell emerged in December 2021, organizations discovered Log4j not just in applications they built, but [embedded in commercial products from hundreds of vendors][Log4Shell-Impact]. Your vendor risk management must account for the open source supply chain hidden inside commercial products.
