---
title: "Corporate Contributions to Open Source Security"
description: "How major technology companies invest in open source security through dedicated teams, funding, tools, and standards work."
...
!!! info "Enlightened Self-Interest Drives Investment"
    Corporate open source security investment isn't charity—it's risk management. Organizations depend on thousands of open source components; contributing to their security directly reduces the probability of supply chain incidents that could cost millions in breach response and remediation.
...
!!! tip "Foundation Membership Provides Governance Voice"
    Beyond funding ecosystem security, foundation membership at premier levels provides board representation and governance participation. This enables organizations to influence strategic direction and ensure ecosystem evolution aligns with their needs.
...
!!! example "Open Source Security Tools From Industry"
    Many essential security tools began as internal corporate projects: Sigstore (Google) for signing, Trivy (Aqua) for scanning, Falco (Sysdig) for runtime security, and OSS-Fuzz (Google) for continuous fuzzing. Releasing these tools publicly multiplied their impact far beyond what any company could achieve alone.
...
**[CoSAI][cosai] and AI security collaboration:**

The **Coalition for Secure AI (CoSAI)**, an OASIS Open Project launched in 2024, extends industry collaboration into AI-era supply chain security. Premier sponsors include Google, IBM, Intel, Microsoft, NVIDIA, and PayPal; participating organizations include Amazon, Anthropic, Chainguard, Cisco, Cohere, GenLab, OpenAI, and others. Its workstreams organize the problem space:

- **WS1, Software Supply Chain Security for AI Systems**: Defines risks and controls for AI supply chains, including **AI-BOM** transparency for models, data, code, and artifacts, and guidance for signing ML artifacts.[^cosai-risks-controls][^cosai-signing-ml]
- **WS2, Preparing Defenders for a Changing Cybersecurity Landscape**: Publishes guidance for defending AI systems, responding to AI incidents, and clarifying shared responsibility across AI providers, deployers, and users.[^cosai-defenders][^cosai-ir][^cosai-shared-responsibility]
- **WS3, AI Security Risk Governance**: Focuses on governance practices for identifying, assigning, and monitoring AI security risk.
- **WS4, Secure Design Patterns for Agentic Systems**: Addresses Model Context Protocol security, agentic identity and access management, and secure design patterns for increasingly autonomous agents.[^cosai-mcp][^cosai-agentic-iam][^cosai-agentic-future]

CoSAI's role is complementary to OpenSSF and CNCF: where those initiatives provide broad open source and cloud-native supply chain infrastructure, CoSAI translates the same discipline—inventory, provenance, signing, incident response, and accountability—into AI-specific systems whose dependencies include datasets, model weights, prompts, tools, and agent permissions.
...
- **Alpha track**: Works directly with maintainers of the most critical open source projects (selected using OpenSSF Criticality Score and Harvard's Census data) through threat modeling, automated security testing, source code audits, and vulnerability remediation support. All engagements follow public charters[^alpha-omega-charters] with defined scope, timeline, named contacts, and monthly progress updates via GitHub.
- **Omega track**: Applies the Omega Analyzer toolchain[^omega-analyzer] with 20+ integrated security tools to systematically analyze at least 10,000 widely deployed projects, combining automated analysis, security analysts, and confidential vulnerability reporting processes
...
[^alpha-omega-charters]: OpenSSF, "Alpha-Omega Engagement Charters," https://github.com/ossf/alpha-omega/tree/main/alpha/engagements
