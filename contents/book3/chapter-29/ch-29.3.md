---
title: "Coordinated Vulnerability Disclosure Ecosystem"
description: "Infrastructure for identifying vulnerabilities, coordinating fixes, and disseminating information through CVE, OSV, and platforms."
...
[GitHub][github-advisories]'s CNA role is particularly significant: maintainers creating repository security advisories can request CVE identifiers from GitHub, which typically reviews eligible requests within 72 hours. This dramatically simplifies the process for projects hosted on the platform.
...
- Supports CVE requests through GitHub's CNA role

When maintainers create security advisories in GitHub, the advisory receives a **GitHub Security Advisory ID (GHSA)**. Maintainers can request a CVE through the advisory workflow; if GitHub determines the vulnerability is eligible, it reserves and publishes the CVE after the advisory becomes public. This integration dramatically simplifies vulnerability documentation for GitHub-hosted projects.
...
5. CVE is requested through the advisory workflow if needed
