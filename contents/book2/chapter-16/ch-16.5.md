---
title: "Developer Psychology and Secure Behavior"
description: "Design systems that produce secure outcomes by working with human nature—make the secure path the easiest path."
icon: "lucide/user-cog"
---

# 16.5 Developer Psychology and Secure Behavior

!!! info "Convenience Often Wins"

    Research shows developers often prioritize functionality, usability, and familiarity over security when selecting packages. This isn't because they don't care—human cognition prioritizes immediate needs over abstract future risks.

Research on how developers choose dependencies—including studies by Wermke et al. on trust in open source software projects[^wermke-2022]—has found that security concerns often rank below convenience, documentation quality, and familiarity. This isn't because developers don't care about security—it's because human cognition prioritizes immediate needs over abstract future risks. Understanding developer psychology is essential for designing systems that produce secure outcomes, not by fighting human nature but by working with it.

[^wermke-2022]: Wermke, D., et al., "Committed to Trust: A Qualitative Study on Security & Trust in Open Source Software Projects," IEEE S&P, 2022, https://ieeexplore.ieee.org/document/9833686
...
Studies on developer dependency selection behavior[^wermke-2022] show that:
...
Industry experience and developer surveys consistently show that security shortcuts are most commonly made under deadline pressure, with deferred security tasks often never being completed.
