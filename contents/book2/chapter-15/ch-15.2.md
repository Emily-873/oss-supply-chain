---
title: "Red Team Exercises for Build Infrastructure"
description: "Simulate adversary attacks against CI/CD systems to test detection and response capabilities—prepare before real attackers arrive."
icon: "lucide/swords"
---
...
!!! warning "Authorization Required"
    ...
    Security testing techniques in this chapter require **explicit written authorization**. Unauthorized access is illegal under the CFAA (18 U.S.C. § 1030) and similar laws worldwide. Obtain written scope, define boundaries, and establish emergency contacts before any testing.

The security testing techniques described in this chapter are intended exclusively for authorized security assessments, penetration testing engagements, and defensive security research conducted with explicit written authorization from system owners. Unauthorized access to computer systems, networks, or data is illegal under the Computer Fraud and Abuse Act (18 U.S.C. § 1030) in the United States and similar laws worldwide, with violations resulting in criminal prosecution, civil liability, and severe penalties including imprisonment.

Before performing any security testing activity described in this chapter, ensure you:
...
!!! tip "Base Scenarios on Real Attacks"

    Design exercises around observed attacks: compromised CI credentials (CircleCI), CI/CD exploitation (SolarWinds), artifact poisoning, and upstream dependency compromise (event-stream). Test detection capabilities, not just vulnerabilities.
...
| **Compromised credentials** | Any (via phishing or stolen session) | Lateral movement | CircleCI incident |
...
- Review Script Security plugin approvals
