---
title: "Adversarial Simulation: Thinking Like an Attacker"
description: "Develop adversarial mindset for supply chain security—map attack paths, identify weak links, and prioritize defenses by attacker ROI."
icon: "lucide/brain"
---

# 15.4 Adversarial Simulation: Thinking Like an Attacker

!!! danger "Attackers Think in Graphs"

    Defenders think in checklists: patch these, configure those, monitor these. Attackers think in connected paths: "If I compromise A, I reach B, which gives access to C." They only need one path; you must protect them all.

![Attackers Think in Graphs](img/ch-15-attackers-think-in-graphs.svg)

The attackers who compromised SolarWinds didn't target random systems—they specifically chose a software vendor whose products were deployed in high-value government and enterprise networks. They understood that one successful compromise could cascade to up to 18,000 customers that downloaded affected Orion updates.[^solarwinds-scope] This is adversarial thinking: understanding how attackers evaluate targets, choose attack paths, and maximize return on their investment. Defenders who think like attackers identify vulnerabilities before exploitation and prioritize defenses where they matter most.

[^solarwinds-scope]: SolarWinds, "SolarWinds Security Advisory," https://www.solarwinds.com/sa-overview/securityadvisory; Microsoft Security Blog, "Analyzing Solorigate," December 2020, https://www.microsoft.com/en-us/security/blog/2020/12/18/analyzing-solorigate-the-compromised-dll-file-that-started-a-sophisticated-cyberattack-and-how-microsoft-defender-helps-protect/
...
!!! tip "Map Attack Paths, Not Just Vulnerabilities"

    For each attacker goal, enumerate paths to reach it. Assess each path's difficulty, detection risk, and impact. Focus defenses on paths with highest impact and lowest detection—those are what attackers will choose.
