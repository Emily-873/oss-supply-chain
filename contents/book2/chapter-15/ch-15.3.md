---
title: "Tabletop Exercises for Supply Chain Incidents"
description: "Practice incident response through discussion-based simulations—build coordination and decision-making skills before the real crisis."
icon: "lucide/clipboard-list"
---

# 15.3 Tabletop Exercises for Supply Chain Incidents

!!! info "Practice Before the Crisis"

    When Log4Shell emerged, organizations that had practiced supply chain incident response mobilized within hours. Those without practiced plans spent days on basic questions: Which apps use Log4j? Who owns them? Tabletops build the muscle memory needed for real incidents.
...
!!! tip "Include More Than Technical Staff"

    Without legal, communications, and executive participation, teams stall on decisions like customer notification. Include: Security/IR lead, Engineering, DevOps, Legal, Communications, Executive sponsor, Product, and Procurement.
