---
title: "Evaluating Project Health"
description: "A framework for assessing open source project health across maintainer activity, community, security practices, and maturity."
...
This section provides a framework for systematically evaluating open source project health across multiple dimensions: maintainer activity, community dynamics, security practices, maturity indicators, and documentation quality. For a complementary perspective, ecosystem researcher Andrew Nesbitt—creator of the ecosyste.ms datasets used later in this chapter—has published his personal library-assessment walkthrough, which pairs well with the structured criteria below.[^nesbitt-assess]

[^nesbitt-assess]: Andrew Nesbitt, "How I Assess Open Source Libraries," December 15, 2025, https://nesbitt.io/2025/12/15/how-i-assess-open-source-libraries.html
...
- **Augur**:[^augur] Open source CHAOSS metrics platform
- **GrimoireLab**:[^grimoirelab] Comprehensive software development analytics
...
!!! tip "Key Health Indicators"

    Watch for: last release >2 years ago, issue response >30 days, activity from bots only, single maintainer with no succession planning, or large PR backlogs with no engagement.
...
!!! warning "Bus Factor Risk"

    A bus factor of 1 means a single point of failure. If that one maintainer disappears, the project becomes unmaintained—and your dependency on it becomes a liability.
...
- **truckfactor**[^truckfactor] and **Truck-Factor**:[^truck-factor] Command-line tools implementing academic algorithms
...
The **CHAOSS (Community Health Analytics in Open Source Software)** project[^chaoss] defines standard community health metrics:
...
```shell
# Check if SECURITY.md exists, either in root or .github
curl -I "https://api.github.com/repos/django/django/contents/SECURITY.md"
curl -I "https://api.github.com/repos/django/django/contents/.github/SECURITY.md"
...
Check badge status at bestpractices.dev.[^bestpractices]
...
- **OpenSSF Scorecard**:[^openssf-scorecard] Automates many security practice checks
- **deps.dev**:[^deps-dev] Aggregates project metadata
- **libraries.io**:[^libraries-io] Tracks releases, dependencies, activity
...
The OpenSSF Security Insights specification[^security-insights-spec] provides a standardized, machine-readable way for projects to communicate their support model. Check for `security-insights.yml` in the repository root or source-forge directory such as `.github/` or `.gitlab/`.
...
header:
  ...
  url: "https://raw.githubusercontent.com/USERNAME/REPO/main/security-insights.yml"

project:
  name: "PROJECT NAME"
  homepage: "https://github.com/USERNAME/REPO"
  roadmap: "https://github.com/USERNAME/REPO/blob/main/roadmap"

repository:
  url: "https://github.com/USERNAME/REPO"
  status: active  # Options include active, inactive, deprecated, archived
  bug-fixes-only: false  # If true, only critical fixes, no features
  accepts-change-request: true
  accepts-automated-change-request: true
```

The `repository` section explicitly communicates maintenance commitment:
...
- **Open Collective**: Listed at opencollective.com[^opencollective]
- **Tidelift**: Commercial support through tidelift.com[^tidelift]
...
- **Apache Software Foundation**: apache.org[^apache-projects]
- **Cloud Native Computing Foundation**: cncf.io[^cncf-projects]
- **Linux Foundation**: Various projects under LF umbrella
- **Python Software Foundation**, **OpenJS Foundation** for Node.js and related JavaScript projects, etc.
...
- **CLOMonitor**:[^clomonitor] CNCF project monitoring, tracks security insights
- **LFX Insights**:[^lfx-insights] Linux Foundation metrics dashboard
- **OSPS Baseline Scanner**:[^osps-baseline] OpenSSF security baseline checks
...
1. **Check for security-insights.yml first.** If present, treat it as the project's stated posture unless observable activity contradicts it.
...
4. **Encourage Security Insights adoption.** Ask dependencies to publish `security-insights.yml`; it reduces assessment burden.
...
[^chaoss]: CHAOSS Project, https://chaoss.community/

[^augur]: CHAOSS, "Augur," https://github.com/chaoss/augur

[^grimoirelab]: CHAOSS, "GrimoireLab," https://chaoss.github.io/grimoirelab/

[^truckfactor]: Helge C. Pedersen, "truckfactor," https://github.com/HelgeCPH/truckfactor

[^truck-factor]: ASERG-UFMG, "Truck-Factor," https://github.com/aserg-ufmg/Truck-Factor

[^bestpractices]: OpenSSF, "Best Practices Badge," https://www.bestpractices.dev/
...
[^security-insights-spec]: OpenSSF, "Security Insights Specification," https://github.com/ossf/security-insights

[^opencollective]: Open Collective, https://opencollective.com

[^tidelift]: Tidelift, https://tidelift.com

[^apache-projects]: Apache Software Foundation, "Projects," https://www.apache.org/index.html#projects-list

[^cncf-projects]: Cloud Native Computing Foundation, "Projects," https://www.cncf.io/projects/
...
[^osps-baseline]: OpenSSF, "Security Baseline," https://github.com/ossf/security-baseline
