---
title: "Dependency Depth and Transitive Risk"
description: "Understand how transitive dependencies dominate your attack surface and learn techniques to measure and manage them."
icon: "lucide/layers"
---
...
- npm projects in the study averaged **30.9 direct dependencies** and **52.8 transitive dependencies**; mean project-level amplification was **4.32×**, with outliers exceeding 10×
- NuGet (.NET) projects averaged **3.9 direct dependencies** and **7.7 transitive dependencies** in the same study
- PyPI (Python) projects averaged **4.2 direct dependencies** and **6.1 transitive dependencies** (1.50× amplification), benefiting from Python's comprehensive standard library
- Maven (Java) exhibited the highest amplification at **24.70×**—projects averaged **5.4 direct dependencies** but pulled in **74.9 transitive dependencies**, for a mean attack surface of **80.3 packages**

!!! note inline end "Ecosystem Variation"

    Amplification varies dramatically: Python 1.5×, npm 4.3×, Maven **24.7×**. In the study, Maven projects averaged 5.4 direct dependencies and 74.9 transitive dependencies.

These statistics come from a [2025 empirical study of dependency amplification][dep-amplification] across 10 package ecosystems.
...
| `uv` | Python | Fast dependency resolution, lockfiles, auditing |
...
[^lodash-deps]: npm registry, "lodash dependents," https://www.npmjs.com/package/lodash?activeTab=dependents — Snyk Open Source Advisor, "lodash," https://snyk.io/advisor/npm-package/lodash
