...
In 2014, Google Security's Neel Mehta and researchers at Codenomicon independently disclosed the Heartbleed vulnerability in OpenSSL—a bug that had existed for more than two years in one of the internet's most critical libraries.[^heartbleed] In the years since, automated fuzzing has become one of the most effective techniques for finding security vulnerabilities that human reviewers and traditional testing miss, with Google's OSS-Fuzz project reporting more than 10,000 vulnerabilities and 36,000 bugs across 1,000 open source projects as of August 2023.[^oss-fuzz-stats] When evaluating dependencies for your supply chain, checking whether a project undergoes continuous fuzzing—or running your own fuzz campaigns—provides evidence about code robustness that vulnerability databases cannot.

[^heartbleed]: "The Heartbleed Bug," heartbleed.com, April 2014, https://heartbleed.com/
[^oss-fuzz-stats]: Google, "OSS-Fuzz," https://google.github.io/oss-fuzz/
...
- **Coverage**: 1,000+ projects, 36,000+ bugs found, 10,000+ security vulnerabilities identified (reported as of August 2023)
