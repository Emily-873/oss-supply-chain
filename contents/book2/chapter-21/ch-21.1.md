...
The TODO Group[^todo-group], a Linux Foundation project for OSPO collaboration, documents OSPO practices and community patterns that help organizations coordinate open source governance across engineering, legal, and security stakeholders.
...
Organizations with strong collaboration mechanisms are better positioned to respond to supply chain incidents. The Log4Shell vulnerability[^log4shell-csrb] illustrated why these relationships matter: response required coordinated inventory, remediation, customer communication, legal review, and executive prioritization under severe time pressure.

## Preparing Defenders for AI Systems

AI systems expand the supply chain security program's attack surface beyond conventional code and dependencies. CoSAI's "Preparing Defenders of AI Systems" describes risks across data collection, model training, inference, deployment, and monitoring, including prompt injection, data extraction, model poisoning, adversarial inputs, and compromised AI tooling or agent frameworks.[^cosai-defenders-ai] Existing AI security frameworks provide useful starting points, but defenders still face fragmented guidance and implementation gaps when translating governance concepts into operational controls.

We recommend treating AI security as a cross-functional extension of the supply chain security program rather than a separate research concern. Security, AppSec, platform engineering, data science, ML engineering, SOC operations, GRC, procurement, and legal teams all need defined roles because AI system security is a team sport: model selection, data provenance, prompt and tool design, runtime monitoring, and incident response sit in different parts of the organization. Extend stakeholder maps, RACI charts, training, and tabletop exercises to include data and ML teams before AI systems become production dependencies.

[^cosai-defenders-ai]: CoSAI, "Preparing Defenders of AI Systems," V1.0, Workstream 2, 2025, https://www.coalitionforsecureai.org/wp-content/uploads/2026/03/preparing-defenders-of-ai-systems.pdf
...
4. **Respect culture**: Integration approaches for an enterprise acquiring a startup differ from a startup acquiring an enterprise division

**Integration approach by scenario**:

**Scenario A: Enterprise acquiring a startup with limited security maturity**
...
[^log4shell-csrb]: Cyber Safety Review Board, "Review of the December 2021 Log4j Event," July 2022, https://www.cisa.gov/resources-tools/resources/csrb-review-december-2021-log4j-event
