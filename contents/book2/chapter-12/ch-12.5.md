---
title: "License Compliance as a Parallel Concern"
description: "Recognize how license and security concerns intersect—the same SBOMs and SCA tools address both, enabling unified governance."
icon: "lucide/scroll"
---
...
!!! warning "AGPL Network Trigger"
    ...
    AGPL adds a "network use" trigger—if you modify AGPL software and let users interact with it over a network, you must offer the corresponding source. Critical for SaaS and cloud services. Often restricted by organizations.

- GPL plus network use trigger
- Network access to modified AGPL software requires offering corresponding source to users
...
Black Duck's 2026 OSSRA report found:[^ossra-license]

- **59%** of audited codebases contain license conflicts
- **8%** of detected components have no license, and another **11%** use custom or modified licenses requiring review
- License issues routinely surface during M&A audits

[^ossra-license]: Black Duck, "2026 Open Source Security and Risk Analysis Report," https://www.blackduck.com/resources/analyst-reports/open-source-security-risk-analysis.html
