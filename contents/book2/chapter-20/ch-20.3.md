---
title: "External Communication and Disclosure"
description: "Balance transparency with timing when notifying customers, partners, and regulators—communication failures compound incident damage."
icon: "lucide/megaphone"
---

# 20.3 External Communication and Disclosure

!!! warning "Communication Failures Compound Incidents"

    Okta's initial LAPSUS$ communications said the Okta service had not been breached, then quantified potential impact as approximately 2.5% of customers. As customers sought concrete guidance, trust eroded because of perceived communication gaps. Cloudflare's transparent, detailed blog post provided notable contrast.

External communication during a supply chain incident determines how customers, partners, and the public perceive your organization's security posture and integrity. When Okta responded to LAPSUS$ claims[^okta-lapsus-statement] in March 2022, their initial communications said the Okta service had not been breached and that customers did not need to take corrective action, then later quantified potential impact as approximately 2.5% of customers. The shift and limited initial detail drew criticism as customers sought concrete guidance. Conversely, when Cloudflare disclosed their Okta exposure with a transparent, detailed blog post[^cloudflare-okta-investigation], their proactive communication provided a notable contrast to Okta's approach.
...
!!! tip "Notify When Actionable"

    Customers should be able to do something with the information. "Your API keys may have been exposed; rotate them immediately" is more valuable than "You may be affected, but we don't know how." Don't wait for complete information—perfect understanding may never arrive.
...
- **Meet regulatory deadlines**: Legal requirements (GDPR's 72-hour supervisory-authority window, various state laws) establish maximum timelines. Plan to meet these even when investigation is ongoing.
...
1. **Identify the security contact**:
   ...
   - Check for bug bounty program (HackerOne[^hackerone], Bugcrowd[^bugcrowd])
   - GitHub Security Advisories[^github-security-advisories] for GitHub-hosted projects
...
3. **Negotiate timeline**:
   - Standard timeline is 90 days (an industry norm established by Google Project Zero[^google-project-zero] and widely adopted), but adjust based on severity and fix complexity
...
|------------|-------|----------------------|-----------|
| GDPR[^gdpr-breach-notification] | EU/EEA personal data | Without undue delay; where feasible, within 72 hours | Supervisory authority |
| California breach notification law[^california-breach-notification] | California resident personal information | Within 30 calendar days, with limited delays | Affected individuals |
| HIPAA[^hipaa-breach] | Protected health information | Without unreasonable delay; no later than 60 days | Individuals; HHS for 500+ |
| FTC Safeguards Rule (GLBA)[^ftc-safeguards-notification] | Financial institution customer information | As soon as possible; no later than 30 days for events affecting 500+ consumers | FTC |
| NIS2[^nis2-article-23] | Critical infrastructure (EU) | 24-hour early warning, 72-hour notification, one-month final report | CSIRT or competent authority |
| SEC Form 8-K[^sec-cyber-disclosure] | Material incidents (public companies) | 4 business days after materiality determination | SEC, public filing |
...
- Contact details for the organization or data protection officer, where applicable
- Likely consequences
...
- GDPR notification to the appropriate EU supervisory authority (for example, the Irish DPC if it is the lead authority)
...
[^gdpr-breach-notification]: GDPR, "Article 33: Notification of a Personal Data Breach to the Supervisory Authority," https://gdpr-info.eu/art-33-gdpr/

[^california-breach-notification]: California Civil Code § 1798.82, https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=1798.82&lawCode=CIV

[^hipaa-breach]: U.S. Department of Health and Human Services, "Breach Notification Rule," https://www.hhs.gov/hipaa/for-professionals/breach-notification/index.html

[^ftc-safeguards-notification]: 16 C.F.R. § 314.4(j), https://www.law.cornell.edu/cfr/text/16/314.4

[^nis2-article-23]: NIS2 Directive, "Article 23: Reporting Obligations," https://www.nis-2-directive.com/NIS_2_Directive_Article_23.html

[^sec-cyber-disclosure]: U.S. Securities and Exchange Commission, "SEC Adopts Rules on Cybersecurity Risk Management, Strategy, Governance, and Incident Disclosure by Public Companies," 2023, https://www.sec.gov/newsroom/press-releases/2023-139
