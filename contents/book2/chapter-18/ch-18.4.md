...
```shell
# Falco: send alerts to stdout during learning; do not wire them to automated response yet
falco -o stdout_output.enabled=true
```
...
[^deno-permissions]: Deno, "Security and permissions," https://docs.deno.com/runtime/fundamentals/security/
