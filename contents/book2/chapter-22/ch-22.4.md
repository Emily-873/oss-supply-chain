---
title: "Managing AI Development Tools"
description: "AI tools are supply chain components—they influence what code gets written and dependencies included. Manage them with governance, controls, and oversight."
icon: "lucide/bot"
---

# 22.4 Managing AI Development Tools

!!! warning "AI Tools Are Supply Chain Components"

    When an AI suggests importing a package that doesn't exist—or one an attacker has registered in anticipation (slopsquatting)—consequences ripple through the supply chain. AI tools propagate insecure patterns learned from training data. Treat them as part of the supply chain, not simple productivity enhancers.

AI coding assistants have transformed software development with remarkable speed. GitHub research found that developers using Copilot completed a controlled coding task 55% faster, and many surveyed users reported higher satisfaction and lower frustration[^github-copilot-research]. But this productivity comes with supply chain security implications that organizations are only beginning to understand. When an AI suggests importing a package that doesn't exist—or worse, one that an attacker has registered in anticipation—the consequences ripple through the software supply chain.
...
!!! tip "Provide Alternatives, Don't Just Ban"

    Developers will use tools that make them productive—sanctioned or not. Banning tools without providing enterprise alternatives drives shadow IT. Providing properly configured enterprise tools with appropriate controls significantly reduces shadow AI usage.
...
|--------|------------|----------|----------|
| **Sanctioned** | Officially approved, supported | Enterprise Copilot, Amazon Q Developer | Full use permitted |
...
```yaml
# Conceptual Copilot enterprise policy; use vendor admin settings/API for actual syntax
copilot:
...
```json
{
  "_comment": "Conceptual Amazon Q Developer policy; use vendor admin settings/API for actual syntax",
  "amazonQDeveloperPolicy": {
...
As discussed in Book 1, Chapter 10, AI models may suggest packages that don't exist—creating opportunities for attackers. The risk extends beyond hallucinations: Endor Labs' 2025 research[^endor-ai-deps] found that **only 1 in 5 dependency versions recommended by AI coding assistants were safe to use**, factoring in both hallucinations and known vulnerabilities. Configure defenses:

[^endor-ai-deps]: Endor Labs, "State of Dependency Management 2025," https://www.endorlabs.com/lp/state-of-dependency-management-2025
...
│   ├── Pre-trained models (GPT-family, Llama, Claude Opus, Gemini, etc.)
...
model_sbom:
  ...
  frameworks:
    - package: transformers
      version: 4.35.2
      vulnerabilities: []  # Populated by vulnerability scanner
...
[^github-copilot-research]: GitHub Blog, "Research: quantifying GitHub Copilot's impact on developer productivity and happiness," 2022, https://github.blog/news-insights/research/research-quantifying-github-copilots-impact-on-developer-productivity-and-happiness/
