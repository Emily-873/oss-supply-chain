---
title: "Dependency Selection Criteria and Vetting"
description: "Establish criteria for dependency adoption—every package is a trust decision with long-term maintenance and security implications."
...
| **Security practices** | Code signing, protected release process | Anonymous maintainers, no signing |
...
- **Multi-factor authentication**: For package registry maintainer accounts, where the registry or organization can require it
...
# npm metadata and release history
npm view [package-name] time version dist-tags maintainers
...
[^ai-hallucination-packages]: Lanyado, Bar. "AI Package Hallucination," Lasso Security, https://www.lasso.security/blog/ai-package-hallucinations
