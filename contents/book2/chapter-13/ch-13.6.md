...
- **Framework EOL**: Django versions, Rails versions, AngularJS (2021)
...
**Ecosystem-Level Help:**

You don't always have to solve unmaintained dependencies alone. The **[Bernie Foundation][bernie-foundation]**—named for the film *Weekend at Bernie's*, after packages that are dead but still propped up beneath enormous download volumes—exists specifically to take on this problem at ecosystem scale. The foundation estimates that roughly one in eight critical repositories is no longer maintained yet sits beneath hundreds of millions of downstream projects, meaning vulnerabilities arrive with "no maintainer to receive it and no fixed version to upgrade to." Its strategy mirrors the options above: **fix** (patch vulnerabilities upstream and manage releases), **fork** (publish maintained forks under foundation stewardship when upstream is unresponsive), and **forgo** (help ecosystems migrate away from high-risk abandoned dependencies). Working alongside funders like Alpha-Omega, it accepts package nominations and sponsored engineering. If a critical dependency in your tree has gone dark, nominating it for stewardship can be cheaper than forking it yourself—and benefits every other consumer of the package.
...
3. [High] OpenSSL 1.0.2 - EOL since December 2019
...
- Data breach from exploited vulnerability: $4.45M average cost (IBM, 2023)[^ibm-data-breach-2023]
...
[^ibm-data-breach-2023]: IBM, "Cost of a Data Breach Report 2023," https://www.ibm.com/reports/data-breach

[bernie-foundation]: https://bernie.foundation
