---
title: "Vendoring vs. Dynamic Dependency Resolution"
description: "Choose between copying dependencies into your repo or fetching at build time—trade-offs between control and maintenance burden."
icon: "lucide/folder-input"
---

# 13.3 Vendoring vs. Dynamic Dependency Resolution

When packages including `left-pad` were unpublished from npm in March 2016, thousands of build pipelines failed worldwide. Developers who had vendored their dependencies continued building; those relying on dynamic resolution watched helplessly. This incident—and countless smaller ones since—highlights a fundamental architectural choice: should you copy dependencies into your repository, or fetch them at build time?

!!! tip "Vendoring Creates a Security Boundary"

    When you vendor, registry compromises don't affect you immediately, deleted packages don't break builds, and all code is in your repository for review. The extra work to update is intentional friction—forcing review of every change.
...
# Verify module cache checksums and vendor consistency
go mod verify
...
!!! warning "Vendoring Trade-off"

    Vendoring trades automatic updates for manual process. Security patches don't flow automatically, each update requires explicit action, and it's easy to forget updates—leading to stale, vulnerable versions.
