...
The **Model Context Protocol** defines how AI applications connect to external capabilities. Anthropic introduced MCP[^mcp-announcement] as an open standard on November 25, 2024, and it has gained adoption across AI tooling ecosystems.
...
- **Transports**: Communication mechanisms (stdio and HTTP-based transports such as SSE or streamable HTTP) connecting clients and servers
...
[^invariant-github]: Invariant Labs, "MCP GitHub Vulnerability: Toxic Agent Flow," 2025, https://invariantlabs.ai/blog/mcp-github-vulnerability
