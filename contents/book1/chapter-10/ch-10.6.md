---
title: "Shadow AI and Ungoverned Tool Usage"
description: "Confront the hidden reality of developers using AI tools without approval, exposing code and introducing untracked dependencies."
icon: "lucide/ghost"
---
...
!!! warning "Shadow AI is Pervasive"

    A KPMG survey found **57% of employees** hid their use of AI at work. Developers in organizations without AI policies are just as likely to use AI tools—they just use personal accounts.
...
!!! example "Samsung Incident (2023)"

    Three separate incidents: employees uploaded semiconductor source code, proprietary meeting notes, and code with internal test data to ChatGPT. Samsung's response—blocking ChatGPT entirely—illustrates the blunt governance choices when shadow AI is discovered after the fact.
...
!!! tip "Enable, Don't Just Prohibit"

    Simply banning AI tools rarely works—developers find workarounds and shadow usage becomes more hidden. Effective approaches acknowledge developers will use AI tools and channel usage toward governed options.
...
Enterprise tiers of GitHub Copilot, Amazon Q Developer, and similar tools offer governance features not available in consumer versions.
...
[^kpmg]: KPMG, "Trust in AI Study," April 2025, https://www.businessinsider.com/kpmg-trust-in-ai-study-2025-how-employees-use-ai-2025-4
[^salesforce-genai]: Salesforce, "AI at Work Research," October 2023, https://www.salesforce.com/news/stories/ai-at-work-research/
