---
title: "AI Coding Assistants and Supply Chain Risk"
description: "Examine how Copilot, Cursor, and other AI tools create a new supply chain intermediary that influences dependency choices."
icon: "lucide/brain"
---

# 10.1 AI Coding Assistants and Supply Chain Risk

The integration of AI into software development represents the most significant change to development workflows in decades. Tools like GitHub Copilot, Cursor, Claude Code, Amazon Q Developer, and Codeium now suggest code, complete functions, and recommend dependencies in real-time. These assistants have moved from novelty to necessity for many developers—GitHub reports that Copilot users accept AI suggestions for over 30% of their code.[^copilot-acceptance] But this integration introduces a new intermediary in the supply chain: an AI system that influences which packages are imported, which patterns are followed, and which libraries developers encounter.
...
!!! warning "A New Intermediary"

    AI coding assistants influence which packages are imported, which patterns are followed, and which libraries developers encounter. The developer may not have specifically chosen a dependency—the AI made that decision.
...
- **Amazon Q Developer**: AWS-integrated assistant (formerly CodeWhisperer) with security scanning
...
!!! note inline end "AI Adoption Scale"

    **76%** of developers are using or planning to use AI coding tools. Copilot users accept approximately **30%** of AI suggestions.
...
For example, an AI trained on code from 2020-2022 might suggest `request` (an npm package deprecated and no longer maintained) rather than modern alternatives.
...
!!! danger "Vibe Coding Risk"

    Developers accepting AI suggestions because they "look right" without understanding the code. Security practitioners report developers who couldn't identify what packages their applications use—the AI chose them, they work, and investigation ends there.
...
| Amazon Q Developer | Built-in security scanning | Yes | Reference tracking | AWS curated training |
...
**Amazon Q Developer's Security Features:**

Amazon Q Developer includes:
...
AI coding assistants are transforming development, and that transformation affects supply chains. The packages developers use, the patterns they follow, and the security of their code are all influenced by AI suggestions. Section 6.6 examined slopsquatting—attackers registering packages that AI assistants hallucinate. The following sections explore package hallucination (10.2), autonomous coding agents (10.3), MCP tool integration (10.4), and model supply chains (10.5), each adding dimensions to how AI reshapes software supply chain risk.

[^github-copilot-stats]: GitHub, "GitHub Copilot in VS Code Free," 2024, https://github.blog/news-insights/product-news/github-copilot-in-vscode-free/
[^stanford-ai-security]: Perry et al., "Do Users Write More Insecure Code with AI Assistants?", 2022, https://arxiv.org/abs/2211.03622
[^karpathy-vibe]: Andrej Karpathy, Twitter/X, February 2025, https://x.com/karpathy
[^stackoverflow-security]: Fischer et al., "Stack Overflow Considered Harmful? The Impact of Copy&Paste on Android Application Security," IEEE S&P 2017, https://ieeexplore.ieee.org/document/9636616
